...
window.CFA.mocktests.push({
name: "Mock Exam 5 — Session 1 (Ethics · Quant · Econ · FSA · Corporate Issuers)",
qs: [
{
q: "Regarding ethical standards, which of the following statements is LEAST accurate?",
opts: ["Ethical conduct goes beyond what is legally required", "Good ethical judgment requires minimizing risks while excluding reputational risk", "To act ethically, individuals must be able to think through the facts and make good choices even in the absence of clear laws"],
ans: 1,
en: "Ethical conduct does go beyond legal minimums, and ethical action requires sound judgment even when no clear rule exists. Good ethical judgment must weigh ALL relevant risks, including reputational risk — excluding it is precisely what makes statement B inaccurate.",
vi: "Hành xử đạo đức vượt trên mức tối thiểu của luật, và hành động đạo đức đòi hỏi phán đoán tốt ngay cả khi không có quy tắc rõ ràng. Phán đoán đạo đức tốt phải cân nhắc MỌI rủi ro liên quan, kể cả rủi ro danh tiếng — việc loại trừ nó chính là điều khiến phát biểu B sai."
},
{
q: "According to the recommended procedures for compliance with the Standard on additional compensation arrangements, a member who plans to accept additional compensation should make an immediate written report specifying the proposed arrangement:",
opts: ["only to her supervisor", "only to her supervisor and her firm's compliance officer", "to her supervisor, her firm's compliance officer, and her clients"],
ans: 0,
en: "Standard IV(B)'s recommended procedure is to make an immediate written report to one's supervisor describing any additional compensation proposed for services that might create a conflict with the employer's interest. The report goes to the supervisor/employer, not to clients.",
vi: "Thủ tục khuyến nghị của Chuẩn mực IV(B) là lập báo cáo bằng văn bản ngay lập tức gửi cấp trên, nêu rõ mọi khoản thù lao bổ sung được đề xuất cho dịch vụ có thể tạo xung đột với lợi ích của nhà tuyển dụng. Báo cáo gửi cấp trên/nhà tuyển dụng, không gửi khách hàng."
},
{
q: "According to the Standards, members are required to disclose conflicts of interest to:",
opts: ["clients only", "clients and employers only", "clients, employers, and prospective clients"],
ans: 2,
en: "Standard VI(A) requires full and fair disclosure of anything that could impair objectivity to clients, prospective clients, and the employer. All three groups must receive disclosure of conflicts.",
vi: "Chuẩn mực VI(A) yêu cầu công bố đầy đủ và công bằng mọi điều có thể làm suy giảm tính khách quan cho khách hàng, khách hàng tiềm năng và nhà tuyển dụng. Cả ba nhóm đều phải được công bố xung đột."
},
{
q: "A member is required to keep information confidential relating to which of the following?",
opts: ["Only prospective clients the member met within the last year", "Only former clients who left the firm more than seven years ago", "Both prospective clients the member met within the last year and former clients who left more than seven years ago"],
ans: 2,
en: "Standard III(E) applies to current, former, AND prospective clients, with no time limit. Both a recent prospect and a long-departed former client are covered.",
vi: "Chuẩn mực III(E) áp dụng cho khách hàng hiện tại, cũ VÀ tiềm năng, không giới hạn thời gian. Cả khách hàng tiềm năng gần đây lẫn khách hàng cũ đã rời đi từ lâu đều được bảo vệ."
},
{
q: "Vanraj Shah has just finished the Level II CFA exam for the second time. He is careful not to discuss specific exam questions, but he calls a friend (a charterholder) and, comparing his two sittings, notes there were many derivatives calculation questions the first time and none the second. Later, on a public blog, he expresses strong disagreement with CFA Institute's shift to computer-based testing. Shah has violated the Standard(s) relating to:",
opts: ["conduct as participants in CFA Institute programs only", "reference to CFA Institute, the CFA designation, and the CFA program only", "both conduct as participants and reference to CFA Institute, the CFA designation, and the CFA program"],
ans: 0,
en: "Revealing the topical mix and question formats (which subjects had calculation questions) discloses confidential exam information, violating Standard VII(A). Expressing disagreement with a CFA Institute policy such as computer-based testing is expressly permitted, so VII(B) is not violated.",
vi: "Tiết lộ cơ cấu chủ đề và dạng câu hỏi (môn nào có câu tính toán) là công bố thông tin mật của kỳ thi, vi phạm Chuẩn mực VII(A). Nêu bất đồng với chính sách của CFA Institute như thi trên máy tính thì được phép rõ ràng, nên không vi phạm VII(B)."
},
{
q: "To be consistent with the Standard on communication with clients and prospective clients, a member:",
opts: ["must share investment recommendations in written form", "should notify clients that additional information is available if a recommendation is shared in capsule form", "is permitted to share investment recommendations solely through a social media service to which most clients have access"],
ans: 1,
en: "When a recommendation is delivered briefly (in capsule form), Standard V(B) says the member should let clients know more detailed analysis is available on request. Communications need not be written, and using a channel only MOST clients can access risks disadvantaging the others.",
vi: "Khi khuyến nghị được trình bày ngắn gọn (dạng cô đọng), Chuẩn mực V(B) nói thành viên nên cho khách hàng biết có phân tích chi tiết hơn khi yêu cầu. Giao tiếp không nhất thiết bằng văn bản, và dùng kênh mà chỉ ĐA SỐ khách hàng truy cập được có nguy cơ gây bất lợi cho những người còn lại."
},
{
q: "Michael Cane, CFA, an investment manager, has a proxy-voting policy stating that voting proxies may not be required in all instances if voting would not benefit clients. The policy is disclosed to clients only upon request. Has Cane violated the Standard relating to loyalty, prudence, and care?",
opts: ["Yes, only because the voting of proxies is required in all instances", "Yes, only because the proxy-voting policy is disclosed to clients only upon request", "Yes, both because voting is required in all instances and because the policy is disclosed only upon request"],
ans: 1,
en: "Voting every proxy is NOT required — a cost-benefit approach that skips votes providing no client benefit is acceptable, so options citing 'required in all instances' are wrong. The violation is disclosure practice: the proxy-voting policy should be communicated to clients, not withheld until a client happens to ask.",
vi: "KHÔNG bắt buộc bỏ phiếu mọi proxy — cách tiếp cận cân nhắc chi phí-lợi ích, bỏ qua các phiếu không mang lại lợi ích cho khách hàng, là chấp nhận được, nên các phương án nói 'bắt buộc trong mọi trường hợp' đều sai. Vi phạm nằm ở khâu công bố: chính sách bỏ phiếu proxy nên được thông báo cho khách hàng, không phải chờ khách hỏi mới cung cấp."
},
{
q: "Which of the following member actions violates the Standard on misconduct? Action 1: declaring personal bankruptcy because of a large loss from investing in a start-up. Action 2: allocating to her personal account shares from an oversubscribed IPO that are suitable for the firm's clients.",
opts: ["Action 1 only", "Action 2 only", "Both Action 1 and Action 2"],
ans: 1,
en: "Personal bankruptcy caused by an investment loss does not, by itself, involve dishonesty and is not misconduct. Taking scarce oversubscribed IPO shares that are suitable for clients into one's own account is deceitful and disadvantages clients, reflecting adversely on professional integrity — a Standard I(D) violation.",
vi: "Phá sản cá nhân do khoản lỗ đầu tư, tự thân nó, không liên quan đến sự gian dối và không phải hành vi sai trái. Lấy cổ phiếu IPO khan hiếm (oversubscribed) vốn phù hợp cho khách hàng vào tài khoản riêng là gian dối và gây bất lợi cho khách hàng, ảnh hưởng xấu đến tính liêm chính nghề nghiệp — vi phạm Chuẩn mực I(D)."
},
{
q: "Which of the following is a recommended procedure for compliance with the Standard on performance presentation? When presenting the firm's investment performance, members should:",
opts: ["present the performance using a single representative account", "maintain the data and records used to calculate the performance being presented", "exclude terminated accounts from the performance history with a clear indication of when they were terminated"],
ans: 1,
en: "Standard III(D) recommends keeping the underlying data and records that support any performance figures presented. Using a single representative account is misleading, and excluding terminated accounts introduces survivorship bias — both are improper.",
vi: "Chuẩn mực III(D) khuyến nghị lưu giữ dữ liệu và hồ sơ cơ sở hỗ trợ mọi số liệu hiệu suất được trình bày. Dùng một tài khoản đại diện duy nhất là gây hiểu lầm, và loại bỏ tài khoản đã chấm dứt tạo survivorship bias — cả hai đều không đúng."
},
{
q: "Marcus Reid, CFA, uses the name 'CFA expert' when posting comments on social media. During a conversation with a friend, Reid mentions, 'I passed all three CFA exams in three consecutive years.' Has Reid violated the Standards?",
opts: ["No", "Yes, because he uses the name 'CFA expert' when posting on social media", "Yes, because he says he passed all three CFA exams in three consecutive years"],
ans: 1,
en: "Standard VII(B) prohibits using the CFA marks improperly or in a way that implies superiority; 'CFA expert' misuses the designation. Stating factually that he passed all three exams in consecutive years is permitted, so the only violation is the 'CFA expert' label.",
vi: "Chuẩn mực VII(B) cấm sử dụng nhãn hiệu CFA sai cách hoặc theo cách ngụ ý sự vượt trội; 'CFA expert' là lạm dụng danh hiệu. Nêu sự thật rằng anh đã đậu cả ba kỳ thi trong các năm liên tiếp thì được phép, nên vi phạm duy nhất là cụm 'CFA expert'."
},
{
q: "Firms that claim compliance with the GIPS standards are required to:",
opts: ["include all fee-paying discretionary accounts in at least one composite", "determine which portfolios to include in a composite immediately after the performance period ends", "exclude the best-performing and worst-performing accounts when representing a strategy's performance"],
ans: 0,
en: "GIPS requires every actual, fee-paying, discretionary portfolio to be included in at least one composite. Portfolios must be assigned to composites on an ex-ante basis (before the period), and excluding the best or worst accounts would be cherry-picking, which GIPS prohibits.",
vi: "GIPS yêu cầu mọi danh mục thực tế, trả phí, có toàn quyền quyết định phải được đưa vào ít nhất một composite. Danh mục phải được gán vào composite trên cơ sở ex-ante (trước kỳ), và loại bỏ các tài khoản tốt nhất hay tệ nhất là cherry-picking mà GIPS cấm."
},
{
q: "Mabel Albright, CFA, resigns and joins a new firm. For a research report at the new firm, she re-creates the supporting records from her memory and uses the historical recommendations she made at her previous firm. Albright violates the Standards:",
opts: ["only by re-creating the supporting records from her memory", "only by using the historical recommendations from her previous firm", "both by re-creating the records from memory and by using the historical recommendations"],
ans: 0,
en: "A member may take her track record of historical recommendations to a new firm, but under Standard V(C) she must re-create the supporting documentation from publicly available information — not rely on memory, which is neither verifiable nor the property she is entitled to reconstruct that way. Using the historical recommendations themselves is permissible.",
vi: "Thành viên có thể mang thành tích khuyến nghị lịch sử của mình sang công ty mới, nhưng theo Chuẩn mực V(C) cô phải tái tạo tài liệu hỗ trợ từ thông tin công khai — không dựa vào trí nhớ, vốn không kiểm chứng được. Việc dùng chính các khuyến nghị lịch sử là được phép."
},
{
q: "Cynthia Garcia, CFA, has a new client, John Hansen, who inherited a large interest in his family's business. Before reviewing his financial situation, Garcia recommends he diversify by buying AAA-rated long-term corporate bonds she has recommended to other clients, telling him, 'You have no downside if you hold these to maturity — they are AAA-rated.' Has Garcia violated the Standards?",
opts: ["No", "Yes, only the Standard relating to suitability", "Yes, both the Standard relating to suitability and the Standard relating to misrepresentation"],
ans: 2,
en: "Recommending securities before assessing the client's objectives and circumstances violates suitability (Standard III(C)). Telling the client there is 'no downside' guarantees an outcome and ignores credit, interest-rate, and reinvestment risk — a misrepresentation (Standard I(C)). Both are violated.",
vi: "Khuyến nghị chứng khoán trước khi đánh giá mục tiêu và hoàn cảnh của khách hàng vi phạm suitability (Chuẩn mực III(C)). Nói với khách rằng 'không có rủi ro giảm giá' là bảo đảm một kết quả và bỏ qua rủi ro tín dụng, lãi suất và tái đầu tư — một misrepresentation (Chuẩn mực I(C)). Vi phạm cả hai."
},
{
q: "Georgia Viggen, CFA, leaves West Star Bank (with no non-compete agreement) to join North South Bank. On starting, she brings a trading software package she developed and used at West Star, uses public information to contact her former clients to move them, and convinces a West Star analyst to join her. Viggen most likely violated the Code and Standards concerning her actions involving:",
opts: ["clients", "the analyst", "the trading software"],
ans: 2,
en: "The trading software Viggen developed at West Star is the employer's property; taking it violates the duty of loyalty (Standard IV(A)). With no non-compete, using public information to contact former clients and recruiting a former colleague are both permissible.",
vi: "Phần mềm giao dịch Viggen phát triển tại West Star là tài sản của nhà tuyển dụng; mang đi là vi phạm nghĩa vụ trung thành (Chuẩn mực IV(A)). Khi không có thỏa thuận không cạnh tranh, dùng thông tin công khai để liên hệ khách hàng cũ và tuyển đồng nghiệp cũ đều được phép."
},
{
q: "David Jacobs, CFA, and Megan Amari, CFA, receive fees for client referrals. Before signing service agreements, Jacobs informs clients about the referral-fee arrangement but does not provide an estimated dollar value. Amari discloses all details, including the estimated dollar value, but only after the agreements are signed. Who has violated the Standards?",
opts: ["Amari only", "Jacobs only", "Both Amari and Jacobs"],
ans: 2,
en: "Standard VI(C) requires disclosing the nature AND value of referral arrangements BEFORE the client enters the agreement. Jacobs disclosed on time but omitted the estimated value (incomplete); Amari's disclosure was complete but too late (after signing). Both fall short.",
vi: "Chuẩn mực VI(C) yêu cầu công bố bản chất VÀ giá trị của thỏa thuận giới thiệu TRƯỚC khi khách ký hợp đồng. Jacobs công bố đúng lúc nhưng thiếu giá trị ước tính (không đầy đủ); Amari công bố đầy đủ nhưng quá muộn (sau khi ký). Cả hai đều chưa đạt."
},
{
q: "According to the GIPS standards, a firm must:",
opts: ["provide a GIPS composite report to all prospective clients", "include terminated composites on its list of composite descriptions for at least seven years after termination", "attain compliance for a minimum of three years, or since inception if younger, to initially claim compliance"],
ans: 0,
en: "Firms must provide a GIPS Composite Report to prospective clients. Terminated composites must stay on the firm's list for at least five years (not seven), and initial compliance requires at least five years of history (not three) or since inception if the firm is younger.",
vi: "Công ty phải cung cấp GIPS Composite Report cho khách hàng tiềm năng. Composite đã chấm dứt phải nằm trong danh sách của công ty ít nhất năm năm (không phải bảy), và tuân thủ ban đầu cần tối thiểu năm năm lịch sử (không phải ba) hoặc từ khi thành lập nếu công ty non trẻ hơn."
},
{
q: "Which of the following actions violate the Standard on market manipulation? Action 1: entering large buy and sell trades between the firm's own proprietary accounts to increase reported trading volume. Action 2: securing a dominant position in an instrument to influence the price of a related derivative. Action 3: exploiting perceived market inefficiencies through aggressive trading strategies.",
opts: ["Action 1 and Action 2 only", "Action 1 and Action 3 only", "Action 2 and Action 3 only"],
ans: 0,
en: "Wash trades between proprietary accounts to inflate volume (Action 1) and cornering a position to move a related derivative's price (Action 2) are both manipulation under Standard II(B). Exploiting genuine inefficiencies through legitimate trading (Action 3) is not manipulation.",
vi: "Giao dịch khống giữa các tài khoản tự doanh để thổi phồng khối lượng (Action 1) và thâu tóm vị thế chi phối để tác động giá một phái sinh liên quan (Action 2) đều là thao túng theo Chuẩn mực II(B). Khai thác điểm kém hiệu quả thật sự bằng giao dịch hợp pháp (Action 3) không phải thao túng."
},
{
q: "According to the Standards, if a member cannot discharge supervisory responsibilities because of an inadequate compliance system, the member is:",
opts: ["only required to decline in writing to accept supervisory responsibility", "only required to report the inadequate compliance system to CFA Institute", "required both to decline in writing to accept supervisory responsibility and to report the inadequate system to CFA Institute"],
ans: 0,
en: "Under Standard IV(C), a member who cannot adequately supervise because compliance procedures are deficient should decline in writing to accept supervisory responsibility until the firm adopts adequate procedures. There is no requirement to report the firm to CFA Institute.",
vi: "Theo Chuẩn mực IV(C), thành viên không thể giám sát đầy đủ vì quy trình tuân thủ thiếu sót nên từ chối bằng văn bản việc nhận trách nhiệm giám sát cho đến khi công ty áp dụng quy trình đầy đủ. Không có yêu cầu phải báo cáo công ty cho CFA Institute."
},
{
q: "Edo Ronde, CFA, overhears the president of Fulda Manufacturing (a company Ronde covers) complaining that a production delay will cut Fulda's earnings by more than 20% next year. Ronde tells his portfolio manager, who had rated Fulda a buy; the manager asks Ronde to write a negative report so the fund can sell. According to the Standards, Ronde should LEAST likely:",
opts: ["revise his research report", "leave his research report as it is", "request that the portfolio manager not act on the information"],
ans: 0,
en: "The overheard earnings information is material and nonpublic, so under Standard II(A) Ronde cannot trade or cause others to trade on it — including revising his report to prompt sales. Leaving the report unchanged and asking the manager not to act are both appropriate; revising the report is what he should least likely do.",
vi: "Thông tin lợi nhuận nghe lỏm là trọng yếu và phi công khai, nên theo Chuẩn mực II(A) Ronde không được giao dịch hay khiến người khác giao dịch dựa trên nó — kể cả sửa báo cáo để thúc đẩy việc bán. Giữ nguyên báo cáo và đề nghị nhà quản lý không hành động đều phù hợp; sửa báo cáo là điều anh ít nên làm nhất."
},
{
q: "To be consistent with the Standard on diligence and reasonable basis, members who develop quantitative models should:",
opts: ["only understand the technical aspects of the products they provide to clients", "only ensure the models incorporate a wide range of possible input expectations", "both understand the technical aspects of the products and ensure the models incorporate a wide range of possible input expectations"],
ans: 2,
en: "Standard V(A) expects those who build quantitative models both to understand the technical workings of what they deliver and to test the models across a wide range of inputs, including extreme values. Both obligations apply.",
vi: "Chuẩn mực V(A) kỳ vọng người xây mô hình định lượng vừa hiểu cơ chế kỹ thuật của sản phẩm cung cấp, vừa kiểm định mô hình trên nhiều loại đầu vào, kể cả các giá trị cực đoan. Cả hai nghĩa vụ đều áp dụng."
},
{
q: "According to the Standard on priority of transactions, members should:",
opts: ["preclear trades in fee-paying family accounts in which the member has no beneficial ownership", "direct their brokers to supply duplicate confirmations of all their personal securities transactions to their employers", "allocate shares to other clients before allocating to fee-paying family accounts in which the member has no beneficial ownership"],
ans: 1,
en: "A recommended procedure under Standard VI(B) is to have brokers send the employer duplicate confirmations of the member's personal trades. Fee-paying family accounts in which the member has no beneficial ownership are ordinary client accounts — they need no preclearance and must not be disadvantaged by being allocated last.",
vi: "Một thủ tục khuyến nghị theo Chuẩn mực VI(B) là yêu cầu môi giới gửi nhà tuyển dụng bản sao xác nhận các giao dịch cá nhân của thành viên. Tài khoản gia đình trả phí mà thành viên không có quyền lợi hưởng dụng là tài khoản khách hàng thông thường — không cần preclearance và không được bị thiệt bằng cách phân bổ sau cùng."
},
{
q: "Riti Malhotra, CFA, an oil and gas analyst, visits a covered company's new refinery. Because no commercial flights serve the site, the company arranges a chartered flight, and it provides modest meals at a nearby hotel. Malhotra lets the company pay these expenses. Has Malhotra violated the Standards?",
opts: ["No", "Yes, the Standard relating to loyalty, prudence, and care", "Yes, the Standard relating to independence and objectivity"],
ans: 0,
en: "Accepting company-paid travel can threaten independence, but when no commercial transportation is available, accepting a chartered flight arranged by the company is acceptable, as are modest meals. There is no violation of Standard I(B).",
vi: "Nhận chuyến đi do công ty chi trả có thể đe dọa tính độc lập, nhưng khi không có phương tiện thương mại, việc nhận chuyến bay thuê do công ty sắp xếp là chấp nhận được, cũng như các bữa ăn giản dị. Không vi phạm Chuẩn mực I(B)."
},
{
q: "Which statement relating to the GIPS standards is accurate? Statement 1: verification improves the consistency of a firm's GIPS-compliant presentations. Statement 2: verification provides assurance to clients that specific composite presentations are accurate.",
opts: ["Statement 1 only", "Statement 2 only", "Both Statement 1 and Statement 2"],
ans: 0,
en: "Verification is performed firm-wide and improves the overall consistency and quality of compliant presentations (Statement 1 is correct). It does not provide assurance about the accuracy of any specific composite presentation — that would require a separate performance examination — so Statement 2 is wrong.",
vi: "Verification được thực hiện trên toàn công ty và cải thiện tính nhất quán và chất lượng chung của các trình bày tuân thủ (Statement 1 đúng). Nó không bảo đảm tính chính xác của bất kỳ trình bày composite cụ thể nào — điều đó cần một performance examination riêng — nên Statement 2 sai."
},
{
q: "Tim Herndon, CFA, and Brad Welch, CFA, co-author all their research reports. Herndon comes to believe Welch is violating the Standard on diligence and reasonable basis. He raises his concern with Welch, his supervisor, and the compliance department, but all three dismiss it. Which action should Herndon most likely take to be consistent with the Standards?",
opts: ["Threaten to leave the firm", "Continue discussing the matter with Welch", "Have his name removed from further research reports"],
ans: 2,
en: "Having exhausted the internal channels without resolution, Herndon should dissociate from the suspected violation. Because the two co-author the reports, dissociating means removing his name from further reports so he is not associated with work he believes lacks a reasonable basis.",
vi: "Sau khi đã dùng hết các kênh nội bộ mà không được giải quyết, Herndon nên tách khỏi vi phạm bị nghi ngờ. Vì hai người đồng tác giả báo cáo, tách khỏi nghĩa là bỏ tên khỏi các báo cáo tiếp theo để không bị gắn với công việc mà anh cho là thiếu cơ sở hợp lý."
},
{
q: "According to the GIPS standards, all fee-paying discretionary accounts must be:",
opts: ["included in at least one composite", "aggregated into composites based on account size", "assigned to composites on an ex-post basis"],
ans: 0,
en: "GIPS requires all actual, fee-paying, discretionary portfolios to appear in at least one composite. Composites are defined by strategy or mandate rather than size, and assignment must be made on an ex-ante basis, not after the fact.",
vi: "GIPS yêu cầu mọi danh mục thực tế, trả phí, có toàn quyền quyết định phải xuất hiện trong ít nhất một composite. Composite được xác định theo chiến lược hay ủy thác chứ không theo quy mô, và việc gán phải làm trên cơ sở ex-ante, không phải sau khi đã biết kết quả."
},
{
q: "James Fung, CFA, is CEO of Wholecare Pharmaceutical (WPC), which is in the final stages of clinical trials for a heart-disease medicine. Fung posts on social media that WPC is launching the new medicine, knowing the news will lift the stock price. Fung has violated the Standard(s) relating to:",
opts: ["only misrepresentation", "only market manipulation", "both misrepresentation and market manipulation"],
ans: 2,
en: "Because the medicine is only in trials, announcing that WPC 'is launching' it is a false, misleading statement (misrepresentation, Standard I(C)). Making that statement to move the share price is information-based market manipulation (Standard II(B)). Both apply.",
vi: "Vì thuốc mới đang thử nghiệm, tuyên bố WPC 'đang tung ra' nó là phát biểu sai, gây hiểu lầm (misrepresentation, Chuẩn mực I(C)). Đưa ra phát biểu đó để tác động giá cổ phiếu là thao túng thị trường dựa trên thông tin (Chuẩn mực II(B)). Cả hai đều áp dụng."
},
{
q: "Heidi Halvorson, CFA, risks losing Quinault Jewelers, a client representing nearly one-third of her firm's revenue, unless performance improves. She buys two corporate bonds she believes are suitable for any of her clients, based on reliable, diligent third-party research. Soon after, one bond rises sharply and the other falls sharply. At day's end she allocates the profitable bond to Quinault and the losing bond to two of her largest institutional accounts. Halvorson most likely violated the Standards with regard to:",
opts: ["client suitability", "trade allocations", "third-party research"],
ans: 1,
en: "The bonds were suitable and the third-party research was sound, so those are not the problems. Steering the winning trade to a favored client and the losing trade to others violates fair dealing in trade allocation (Standard III(B)) — allocations should be made fairly, typically pre-trade.",
vi: "Các trái phiếu phù hợp và nghiên cứu bên thứ ba đáng tin, nên đó không phải vấn đề. Dồn giao dịch có lãi cho khách hàng được ưu ái và giao dịch thua lỗ cho người khác vi phạm nguyên tắc đối xử công bằng trong phân bổ lệnh (Chuẩn mực III(B)) — phân bổ phải công bằng, thường là trước khi giao dịch."
},
{
q: "If inventory is written down:",
opts: ["inventory turnover will be higher than if the write-down did not occur", "the net profit margin will be higher than if the write-down did not occur", "the interest coverage ratio will be higher than if the write-down did not occur"],
ans: 0,
en: "A write-down raises cost of sales and lowers ending inventory, so inventory turnover (COGS/average inventory) rises — numerator up, denominator down. It reduces net income, so net profit margin and interest coverage (EBIT/interest) both fall.",
vi: "Ghi giảm hàng tồn kho làm tăng giá vốn và giảm tồn kho cuối, nên vòng quay tồn kho (COGS/tồn kho bình quân) tăng — tử số tăng, mẫu số giảm. Nó làm giảm lợi nhuận ròng, nên biên lợi nhuận ròng và interest coverage (EBIT/lãi vay) đều giảm."
},
{
q: "Which of the following ratios will most likely increase as a result of an inventory write-down?",
opts: ["Current ratio", "Total asset turnover ratio", "Receivables turnover ratio"],
ans: 1,
en: "A write-down lowers inventory and thus total assets, so total asset turnover (revenue/total assets) increases. It reduces current assets, lowering the current ratio, and it leaves receivables unchanged, so receivables turnover is unaffected.",
vi: "Ghi giảm làm giảm tồn kho và do đó tổng tài sản, nên total asset turnover (doanh thu/tổng tài sản) tăng. Nó làm giảm tài sản ngắn hạn, hạ current ratio, và không đổi khoản phải thu nên receivables turnover không bị ảnh hưởng."
},
{
q: "Which of the following best describes a lin-log regression model?",
opts: ["Y = b0 + b1 ln(X)", "ln(Y) = b0 + b1 X", "ln(Y) = b0 + b1 ln(X)"],
ans: 0,
en: "In a lin-log model the dependent variable is in levels (linear) and the independent variable is in natural logs: Y = b0 + b1 ln(X). A log-lin model logs only Y, and a log-log model logs both variables.",
vi: "Trong mô hình lin-log, biến phụ thuộc ở dạng mức (tuyến tính) và biến độc lập ở dạng log tự nhiên: Y = b0 + b1 ln(X). Mô hình log-lin chỉ lấy log của Y, và log-log lấy log cả hai biến."
},
{
q: "An analyst gathers the following: target debt-to-equity ratio 0.80; current debt-to-equity ratio 0.65; yield to maturity on debt 4%; cost of equity 9%; tax rate 30%. The WACC to be used in financial analysis is closest to:",
opts: ["6.24%", "6.56%", "6.78%"],
ans: 0,
en: "Use the TARGET structure. D/E of 0.80 gives weights wD = 0.80/1.80 = 0.4444 and wE = 1/1.80 = 0.5556. WACC = 0.4444(4%)(1 - 0.30) + 0.5556(9%) = 1.244% + 5.000% = 6.24%.",
vi: "Dùng cấu trúc MỤC TIÊU. D/E 0.80 cho trọng số wD = 0.80/1.80 = 0.4444 và wE = 1/1.80 = 0.5556. WACC = 0.4444(4%)(1 - 0.30) + 0.5556(9%) = 1.244% + 5.000% = 6.24%."
},
{
q: "A fund's returns are: Year 1 -20.60%; Year 2 15.00%; Year 3 0.50%; Year 4 9.80%; Year 5 4.60%. The mean absolute deviation (MAD) of the returns is closest to:",
opts: ["9.53%", "11.91%", "13.69%"],
ans: 0,
en: "The mean is (-20.60 + 15.00 + 0.50 + 9.80 + 4.60)/5 = 1.86%. The absolute deviations sum to 22.46 + 13.14 + 1.36 + 7.94 + 2.74 = 47.64, and MAD = 47.64/5 = 9.53%.",
vi: "Trung bình là (-20.60 + 15.00 + 0.50 + 9.80 + 4.60)/5 = 1.86%. Tổng các độ lệch tuyệt đối là 22.46 + 13.14 + 1.36 + 7.94 + 2.74 = 47.64, và MAD = 47.64/5 = 9.53%."
},
{
q: "Ignoring income taxes, the recognition of an impairment loss on long-lived assets most likely results in a:",
opts: ["lower quick ratio", "higher total asset turnover ratio", "lower cash flow from operations"],
ans: 1,
en: "An impairment writes down a long-lived (non-current) asset, reducing total assets, so total asset turnover rises. It does not touch the current assets in the quick ratio, and being a non-cash charge that is added back, it leaves operating cash flow unchanged.",
vi: "Suy giảm giá trị ghi giảm một tài sản dài hạn (không phải ngắn hạn), làm giảm tổng tài sản, nên total asset turnover tăng. Nó không đụng đến tài sản ngắn hạn trong quick ratio, và là khoản chi phí phi tiền mặt được cộng lại nên dòng tiền hoạt động không đổi."
},
{
q: "In jackknife resampling:",
opts: ["the results are similar for every resample", "the required number of repetitions is the same as in bootstrap resampling", "each subsequent resample has one less observation than the previous resample"],
ans: 0,
en: "The jackknife omits one observation at a time, producing n samples each of size n - 1. Because each sample differs from the others by only one observation, the results are similar across resamples, and the procedure is deterministic — unlike the bootstrap, which draws a chosen (often larger) number of random samples with replacement.",
vi: "Jackknife bỏ đi một quan sát mỗi lần, tạo n mẫu mỗi mẫu cỡ n - 1. Vì mỗi mẫu chỉ khác nhau một quan sát, kết quả giữa các resample tương tự nhau, và quy trình mang tính tất định — khác với bootstrap vốn lấy một số lượng (thường lớn hơn) mẫu ngẫu nhiên có hoàn lại."
},
{
q: "Which sampling method results in samples that are most representative of desired subgroups within a non-homogeneous population?",
opts: ["Cluster sampling", "Simple random sampling", "Stratified random sampling"],
ans: 2,
en: "Stratified random sampling divides the population into strata (subgroups) and samples from each in proportion, guaranteeing that every subgroup is represented. That makes it best for non-homogeneous populations.",
vi: "Stratified random sampling chia tổng thể thành các tầng (subgroup) và lấy mẫu từ mỗi tầng theo tỷ lệ, bảo đảm mọi subgroup đều được đại diện. Điều đó khiến nó tốt nhất cho tổng thể không đồng nhất."
},
{
q: "An analyst gathers the following about three portfolios. Portfolio X: expected return 10%, standard deviation 12%. Portfolio Y: expected return 12%, standard deviation 16%. Portfolio Z: expected return 14%, standard deviation 20%. If the shortfall (threshold) level is 5%, which portfolio has the largest safety-first ratio?",
opts: ["Portfolio X", "Portfolio Y", "Portfolio Z"],
ans: 2,
en: "Roy's safety-first ratio = (expected return - threshold)/standard deviation. X = (10 - 5)/12 = 0.417; Y = (12 - 5)/16 = 0.438; Z = (14 - 5)/20 = 0.450. Portfolio Z has the highest ratio and thus the lowest probability of falling below 5%.",
vi: "Tỷ số safety-first của Roy = (lợi suất kỳ vọng - ngưỡng)/độ lệch chuẩn. X = (10 - 5)/12 = 0.417; Y = (12 - 5)/16 = 0.438; Z = (14 - 5)/20 = 0.450. Portfolio Z có tỷ số cao nhất nên xác suất rơi dưới 5% thấp nhất."
},
{
q: "Which ratio is most appropriate for evaluating a company's ability to meet its short-term obligations?",
opts: ["Defensive interval ratio", "Financial leverage ratio", "Working capital turnover ratio"],
ans: 0,
en: "The defensive interval ratio measures how many days a firm can cover its daily cash expenditures from its most liquid assets, directly gauging short-term solvency. Financial leverage measures long-term solvency, and working capital turnover measures efficiency.",
vi: "Defensive interval ratio đo số ngày một công ty có thể trang trải chi tiêu tiền mặt hằng ngày từ các tài sản thanh khoản nhất, đánh giá trực tiếp khả năng thanh toán ngắn hạn. Financial leverage đo khả năng thanh toán dài hạn, và working capital turnover đo hiệu quả."
},
{
q: "Which of the following is a secondary source of liquidity for a company?",
opts: ["Trade credit", "Bank line of credit", "Bankruptcy protection and reorganization"],
ans: 2,
en: "Primary sources of liquidity are routine and low-cost, such as trade credit, bank lines, and operating cash flow. Secondary sources — negotiating debt, liquidating assets, or filing for bankruptcy protection and reorganization — signal distress and materially affect the business.",
vi: "Nguồn thanh khoản sơ cấp là các nguồn thường nhật, chi phí thấp như tín dụng thương mại, hạn mức ngân hàng và dòng tiền hoạt động. Nguồn thứ cấp — tái đàm phán nợ, thanh lý tài sản, hoặc nộp đơn bảo hộ phá sản và tái cấu trúc — báo hiệu khó khăn và ảnh hưởng đáng kể đến hoạt động."
},
{
q: "An analyst gathers the following: cash flow from operating activities EUR 600,000; preferred dividends declared and paid EUR 30,000; total dividends declared and paid EUR 120,000; common shares outstanding 100,000 (unchanged during the year). If the company reports the total dividends paid as an operating cash outflow, cash flow per share is:",
opts: ["EUR 5.70", "EUR 6.30", "EUR 6.90"],
ans: 2,
en: "Cash flow per share = (operating cash flow - preferred dividends)/common shares, where dividends paid should not reduce operating cash flow. Adding back the EUR 120,000 of dividends improperly included in operations gives adjusted CFO of 720,000; then (720,000 - 30,000)/100,000 = EUR 6.90.",
vi: "Cash flow per share = (dòng tiền hoạt động - cổ tức ưu đãi)/số cổ phiếu thường, trong đó cổ tức đã trả không nên làm giảm dòng tiền hoạt động. Cộng lại 120,000 EUR cổ tức bị đưa nhầm vào hoạt động cho CFO điều chỉnh 720,000; rồi (720,000 - 30,000)/100,000 = 6.90 EUR."
},
{
q: "Which method is most appropriate to assess the impact of a geopolitical risk?",
opts: ["Groupthink", "Scenario analysis", "Linear quantitative modeling"],
ans: 1,
en: "Geopolitical risks are hard to quantify and often non-linear, so scenario analysis — examining a range of plausible outcomes and their portfolio effects — is the most appropriate tool. Groupthink is a decision-making pitfall, not an analytical method.",
vi: "Rủi ro địa chính trị khó lượng hóa và thường phi tuyến, nên scenario analysis — xem xét một loạt kết cục hợp lý và tác động của chúng lên danh mục — là công cụ phù hợp nhất. Groupthink là một cạm bẫy ra quyết định, không phải phương pháp phân tích."
},
{
q: "Credit cycles:",
opts: ["can amplify business cycles", "are defined as fluctuations in real GDP", "tend to be shorter than business cycles"],
ans: 0,
en: "Credit cycles — the expansion and contraction of credit availability — are procyclical and can amplify business cycles. Fluctuations in real GDP define the business cycle itself, and credit cycles tend to be longer than business cycles, not shorter.",
vi: "Credit cycle — sự mở rộng và thu hẹp khả năng tiếp cận tín dụng — có tính thuận chu kỳ và có thể khuếch đại chu kỳ kinh doanh. Biến động của GDP thực định nghĩa chính chu kỳ kinh doanh, và credit cycle thường dài hơn chu kỳ kinh doanh chứ không ngắn hơn."
},
{
q: "An analyst gathers the following: ROE 12%; ROA 8%; total asset turnover 2.0; tax burden 0.4; interest burden 0.8. The pretax margin is closest to:",
opts: ["10.0%", "12.5%", "15.0%"],
ans: 0,
en: "Net profit margin = ROA/total asset turnover = 8%/2.0 = 4%. Since net profit margin = tax burden x pretax margin, pretax margin = 4%/0.4 = 10.0%.",
vi: "Net profit margin = ROA/total asset turnover = 8%/2.0 = 4%. Vì net profit margin = tax burden x pretax margin, nên pretax margin = 4%/0.4 = 10.0%."
},
{
q: "An analyst gathers the following about an investment: initial investment USD 100; value at the end of Year 1 USD 90; additional amount invested at the beginning of Year 2 USD 10; value at the end of Year 2 USD 110. The annualized time-weighted rate of return over the two-year period is closest to:",
opts: ["-0.5%", "0.0%", "4.9%"],
ans: 0,
en: "Year 1 return = 90/100 - 1 = -10%. After adding 10 the Year 2 base is 100, so Year 2 return = 110/100 - 1 = +10%. The time-weighted return is (0.90)(1.10) = 0.99 over two years; annualized, 0.99^(1/2) - 1 = -0.5%.",
vi: "Lợi suất Năm 1 = 90/100 - 1 = -10%. Sau khi thêm 10, cơ sở Năm 2 là 100, nên lợi suất Năm 2 = 110/100 - 1 = +10%. Time-weighted return là (0.90)(1.10) = 0.99 trong hai năm; quy về năm, 0.99^(1/2) - 1 = -0.5%."
},
{
q: "If a paired comparison test of mean differences supports rejecting the null hypothesis, then the:",
opts: ["difference in means is not statistically significant", "independence of the samples is statistically significant", "standard error of the mean differences is low relative to the sample mean difference"],
ans: 2,
en: "Rejecting the null means the mean difference IS statistically significant, so the first choice is wrong. Paired tests use dependent (not independent) samples. Rejection requires a large t-statistic (mean difference divided by its standard error), which happens when the standard error is small relative to the mean difference.",
vi: "Bác bỏ giả thuyết không nghĩa là chênh lệch trung bình CÓ ý nghĩa thống kê, nên phương án đầu sai. Kiểm định cặp dùng mẫu phụ thuộc (không độc lập). Bác bỏ cần thống kê t lớn (chênh lệch trung bình chia cho sai số chuẩn của nó), xảy ra khi sai số chuẩn nhỏ so với chênh lệch trung bình."
},
{
q: "Which statement is most accurate? According to Modigliani-Miller Proposition I without taxes:",
opts: ["firm value can be created by changing a company's capital structure", "any increase in the cost of equity must exactly offset the greater use of lower-cost debt", "equity holders demand a higher return as leverage increases to offset increased risk"],
ans: 1,
en: "Proposition I (no taxes) states that firm value and WACC are independent of capital structure. That holds precisely because the rise in the cost of equity from adding leverage exactly offsets the greater use of cheaper debt, leaving WACC unchanged. The statement that equity holders demand more as leverage rises is Proposition II.",
vi: "Proposition I (không thuế) nói giá trị doanh nghiệp và WACC độc lập với cấu trúc vốn. Điều đó đúng chính vì mức tăng chi phí vốn cổ phần khi thêm đòn bẩy bù trừ vừa khít với việc dùng nhiều nợ rẻ hơn, khiến WACC không đổi. Phát biểu rằng cổ đông đòi hỏi nhiều hơn khi đòn bẩy tăng là Proposition II."
},
{
q: "In capital investment decisions, project sequencing is most likely a type of:",
opts: ["timing option", "flexibility option", "fundamental option"],
ans: 0,
en: "Project sequencing invests in one project to obtain the option to invest in a follow-on project later, depending on how the first turns out. Because it concerns when (and whether) to make the subsequent investment, it is a form of timing option.",
vi: "Project sequencing đầu tư vào một dự án để có quyền đầu tư vào dự án tiếp theo về sau, tùy kết quả dự án đầu. Vì nó liên quan đến việc khi nào (và có nên) thực hiện khoản đầu tư kế tiếp, nó là một dạng timing option."
},
{
q: "Under IFRS, reversals of impairments of long-lived assets are allowed:",
opts: ["for previously recognized impairment losses only", "if the recoverable amount exceeds the previous carrying amount", "for assets held for sale only"],
ans: 0,
en: "IFRS permits reversing an impairment on a long-lived asset held for use, but only to the extent of previously recognized impairment losses — the reversal cannot raise the carrying amount above what it would have been (net of depreciation) without the original impairment.",
vi: "IFRS cho phép hoàn nhập suy giảm giá trị của tài sản dài hạn đang sử dụng, nhưng chỉ trong phạm vi các khoản lỗ suy giảm đã ghi nhận trước đó — hoàn nhập không được nâng giá trị ghi sổ vượt mức lẽ ra có (đã trừ khấu hao) nếu không có suy giảm ban đầu."
},
{
q: "For a manufacturing company reporting under US GAAP, which of the following is classified as an operating activity on the statement of cash flows?",
opts: ["Dividends paid", "Purchase of treasury stock", "Purchase of trading securities"],
ans: 2,
en: "Under US GAAP, purchases and sales of trading securities are operating activities. Dividends paid and purchases of treasury stock are both financing activities.",
vi: "Theo US GAAP, mua và bán chứng khoán kinh doanh (trading securities) là hoạt động kinh doanh. Cổ tức đã trả và mua cổ phiếu quỹ đều là hoạt động tài chính."
},
{
q: "Which pricing model combines multiple products so that customers are incentivized to buy them together?",
opts: ["Bundling", "Tiered pricing", "Value-based pricing"],
ans: 0,
en: "Bundling packages multiple products or services together and prices the package to encourage buying them jointly. Tiered pricing offers different price points for different service levels, and value-based pricing sets price by perceived customer value.",
vi: "Bundling đóng gói nhiều sản phẩm hoặc dịch vụ cùng nhau và định giá gói để khuyến khích mua chung. Tiered pricing đưa ra các mức giá khác nhau cho các cấp dịch vụ khác nhau, và value-based pricing định giá theo giá trị cảm nhận của khách hàng."
},
{
q: "Which strategy is LEAST likely to be used by shareholder activists?",
opts: ["Initiating a proxy battle", "Implementing a poison pill", "Filing a shareholder derivative lawsuit"],
ans: 1,
en: "Proxy battles and derivative lawsuits are tools activists use to pressure a company. A poison pill is a takeover DEFENSE deployed by the board or management to resist activists and acquirers, so activists would not use it.",
vi: "Proxy battle và derivative lawsuit là công cụ nhà đầu tư chủ động dùng để gây áp lực lên công ty. Poison pill là biện pháp PHÒNG THỦ chống thâu tóm do HĐQT hay ban lãnh đạo triển khai để chống lại nhà hoạt động và bên thâu tóm, nên nhà hoạt động sẽ không dùng nó."
},
{
q: "A well-defined supply function is most likely available to:",
opts: ["a monopolist", "a firm operating in perfect competition", "a firm operating in monopolistic competition"],
ans: 1,
en: "Only under perfect competition does a firm have a well-defined supply curve — its marginal cost curve above minimum average variable cost. Firms with pricing power (monopoly, monopolistic competition) do not have a single supply function.",
vi: "Chỉ trong cạnh tranh hoàn hảo, doanh nghiệp mới có đường cung xác định — đường chi phí biên nằm trên mức chi phí biến đổi trung bình tối thiểu. Doanh nghiệp có sức mạnh định giá (độc quyền, cạnh tranh độc quyền) không có một hàm cung duy nhất."
},
{
q: "An analyst gathers revenue and leverage data for three companies in the same industry at different life-cycle stages. Company 1: revenue USD 10M, 11M, 9M over three years; Year 3 debt/capital 0%. Company 2: revenue 30M, 36M, 44M; debt/capital 8%. Company 3: revenue 100M, 95M, 97M; debt/capital 25%. The company with the greatest capacity to absorb additional leverage in Year 4 is most likely:",
opts: ["Company 1", "Company 2", "Company 3"],
ans: 1,
en: "Capacity to add debt depends on both stable/growing cash flows and low existing leverage. Company 2 combines strong, steady revenue growth with low leverage (8%), giving it the greatest ability to service more debt. Company 1's revenue is volatile and declining, and Company 3 already carries the most debt with flat revenue.",
vi: "Khả năng gánh thêm nợ phụ thuộc cả vào dòng tiền ổn định/tăng trưởng lẫn đòn bẩy hiện có thấp. Company 2 kết hợp doanh thu tăng mạnh, đều đặn với đòn bẩy thấp (8%), cho khả năng phục vụ thêm nợ lớn nhất. Doanh thu Company 1 biến động và giảm, còn Company 3 đã gánh nhiều nợ nhất với doanh thu đi ngang."
},
{
q: "An analyst gathers the following: USD/EUR spot rate 1.0351; one-week USD/EUR forward points -1.1 (USD/EUR is the amount of USD per 1 EUR). The one-week USD/EUR forward rate is closest to:",
opts: ["1.02410", "1.03400", "1.03499"],
ans: 2,
en: "Forward points are quoted in the fourth decimal (pips). Forward rate = 1.0351 + (-1.1/10,000) = 1.0351 - 0.00011 = 1.03499.",
vi: "Forward points được yết ở chữ số thập phân thứ tư (pip). Tỷ giá forward = 1.0351 + (-1.1/10,000) = 1.0351 - 0.00011 = 1.03499."
},
{
q: "A sign of expansionary fiscal policy is a(n):",
opts: ["increase in indirect taxes", "increase in the budget deficit", "reduction in reserve requirements for banks"],
ans: 1,
en: "Expansionary fiscal policy means higher government spending and/or lower taxes, which enlarges the budget deficit. Raising indirect taxes is contractionary, and changing reserve requirements is a monetary-policy tool, not fiscal.",
vi: "Chính sách tài khóa mở rộng nghĩa là chi tiêu chính phủ cao hơn và/hoặc thuế thấp hơn, làm phình thâm hụt ngân sách. Tăng thuế gián thu là thắt chặt, và thay đổi dự trữ bắt buộc là công cụ chính sách tiền tệ, không phải tài khóa."
},
{
q: "An investor needs USD 10,000 in ten years and has USD 7,500 to invest today. Account 1: stated annual rate 3.0%, compounded quarterly. Account 2: stated annual rate 2.9%, compounded daily. Which account(s) will allow the investor to reach the goal?",
opts: ["Account 1 only", "Account 2 only", "Both Account 1 and Account 2"],
ans: 2,
en: "Account 1: 7,500(1 + 0.03/4)^40 = 7,500(1.34838) = 10,113. Account 2: 7,500(1 + 0.029/365)^3650 = 7,500(1.33639) = 10,023. Both grow the 7,500 to at least 10,000, so either account works.",
vi: "Account 1: 7,500(1 + 0.03/4)^40 = 7,500(1.34838) = 10,113. Account 2: 7,500(1 + 0.029/365)^3650 = 7,500(1.33639) = 10,023. Cả hai đều tăng 7,500 lên ít nhất 10,000, nên tài khoản nào cũng đạt."
},
{
q: "Which area is most likely to apply natural language processing?",
opts: ["Data encryption", "Compliance functions", "Analysis of structured data"],
ans: 1,
en: "Natural language processing extracts meaning from unstructured text, making it well suited to compliance functions such as monitoring communications and analyzing regulatory filings. Encryption and structured-data analysis do not rely on NLP.",
vi: "Natural language processing rút trích ý nghĩa từ văn bản phi cấu trúc, phù hợp với các chức năng tuân thủ như giám sát liên lạc và phân tích hồ sơ pháp lý. Mã hóa và phân tích dữ liệu có cấu trúc không dựa vào NLP."
},
{
q: "The following ten observations are a sample from a normal population: 25, 20, 18, -5, 35, 21, -11, 8, 20, and 9. The mean of the sample is closest to:",
opts: ["14.00", "15.56", "17.20"],
ans: 0,
en: "The sum is 25 + 20 + 18 - 5 + 35 + 21 - 11 + 8 + 20 + 9 = 140. Dividing by the ten observations gives a mean of 14.00.",
vi: "Tổng là 25 + 20 + 18 - 5 + 35 + 21 - 11 + 8 + 20 + 9 = 140. Chia cho mười quan sát cho trung bình 14.00."
},
{
q: "The arithmetic mean and the geometric mean are calculated for the same data. If there is variability in the data, then compared with the arithmetic mean, the geometric mean will most likely be:",
opts: ["smaller", "equal", "greater"],
ans: 0,
en: "For a set of positive numbers, the geometric mean is less than or equal to the arithmetic mean, with equality only when every value is identical. Since the data show variability, the geometric mean is strictly smaller.",
vi: "Với một tập số dương, geometric mean nhỏ hơn hoặc bằng arithmetic mean, chỉ bằng khi mọi giá trị giống hệt. Vì dữ liệu có biến động, geometric mean nhỏ hơn hẳn."
},
{
q: "A company's interest payments are fully tax deductible. When tax rates increase, the company's cost of debt:",
opts: ["decreases", "remains the same", "increases"],
ans: 0,
en: "The after-tax cost of debt equals the pre-tax rate times (1 - tax rate). A higher tax rate makes the (1 - tax rate) factor smaller, so the after-tax cost of debt falls as the tax shield grows.",
vi: "Chi phí nợ sau thuế bằng lãi suất trước thuế nhân (1 - thuế suất). Thuế suất cao hơn làm hệ số (1 - thuế suất) nhỏ hơn, nên chi phí nợ sau thuế giảm khi lá chắn thuế tăng."
},
{
q: "If a company's receivables turnover ratio is equal to its payables turnover ratio, the company's cash conversion cycle is equal to its number of days of:",
opts: ["payables", "sales outstanding", "inventory on hand"],
ans: 2,
en: "The cash conversion cycle = days of sales outstanding + days of inventory - days of payables. Equal receivables and payables turnover means days of sales outstanding equals days of payables, so those two cancel and the cycle equals the days of inventory on hand.",
vi: "Chu kỳ chuyển đổi tiền mặt = số ngày phải thu + số ngày tồn kho - số ngày phải trả. Vòng quay phải thu bằng vòng quay phải trả nghĩa là số ngày phải thu bằng số ngày phải trả, nên hai phần đó triệt tiêu và chu kỳ bằng số ngày tồn kho."
},
{
q: "In a fixed parity currency regime, excess private demand for the domestic currency:",
opts: ["implies a depleting stock of foreign exchange reserves", "makes no implication about the country's foreign exchange reserves", "implies a growing stock of foreign exchange reserves"],
ans: 2,
en: "To hold the peg against upward pressure, the central bank must sell (supply) domestic currency and buy foreign currency, accumulating reserves. So excess demand for the domestic currency implies a growing stock of foreign exchange reserves.",
vi: "Để giữ tỷ giá cố định trước áp lực tăng giá, ngân hàng trung ương phải bán (cung) nội tệ và mua ngoại tệ, tích lũy dự trữ. Vậy cầu vượt trội đối với nội tệ hàm ý dự trữ ngoại hối tăng lên."
},
{
q: "In a period of rising prices and stable inventory quantities, the value of ending inventory will most closely reflect current replacement value under which inventory valuation method?",
opts: ["FIFO", "LIFO", "Weighted average cost"],
ans: 0,
en: "Under FIFO, the oldest costs flow to cost of goods sold and the newest, most recent purchase costs remain in ending inventory. That leaves ending inventory closest to current replacement cost when prices are rising.",
vi: "Theo FIFO, chi phí cũ nhất chuyển vào giá vốn và chi phí mua mới nhất còn lại trong tồn kho cuối. Điều đó khiến tồn kho cuối gần với chi phí thay thế hiện tại nhất khi giá tăng."
},
{
q: "An analyst gathers the following exchange rate information. Spot: AUD/USD 1.3889, AUD/EUR 1.6393. Forward: AUD/USD 1.3195, AUD/EUR 1.4875. (AUD/USD is the amount of AUD per 1 USD; AUD/EUR is the amount of AUD per 1 EUR.) The USD is expected to depreciate against:",
opts: ["the AUD only", "the EUR only", "both the AUD and the EUR"],
ans: 0,
en: "For AUD/USD, the forward (1.3195) is below the spot (1.3889): 1 USD buys fewer AUD forward, so the USD depreciates against the AUD. For the USD versus EUR, build USD/EUR = (AUD/EUR)/(AUD/USD): spot = 1.6393/1.3889 = 1.1803 and forward = 1.4875/1.3195 = 1.1273. Fewer USD per EUR forward means the EUR weakens and the USD strengthens against the EUR. So the USD depreciates against the AUD only.",
vi: "Với AUD/USD, forward (1.3195) thấp hơn spot (1.3889): 1 USD mua được ít AUD hơn ở forward, nên USD giảm giá so với AUD. Với USD so với EUR, lập USD/EUR = (AUD/EUR)/(AUD/USD): spot = 1.6393/1.3889 = 1.1803 và forward = 1.4875/1.3195 = 1.1273. Ít USD trên mỗi EUR ở forward nghĩa là EUR yếu đi và USD mạnh lên so với EUR. Vậy USD chỉ giảm giá so với AUD."
},
{
q: "All else being equal, an increase in the central bank's policy rate most likely puts downward pressure on domestic inflation by:",
opts: ["increasing consumption growth", "improving investors' confidence", "strengthening the country's currency"],
ans: 2,
en: "A higher policy rate tends to attract capital inflows and strengthen the domestic currency, which lowers import prices and eases inflation. Higher rates dampen (not increase) consumption growth, and confidence is not the transmission channel described here.",
vi: "Lãi suất chính sách cao hơn có xu hướng thu hút dòng vốn vào và làm mạnh nội tệ, khiến giá nhập khẩu giảm và hạ lạm phát. Lãi suất cao làm giảm (không tăng) tăng trưởng tiêu dùng, và niềm tin không phải kênh truyền dẫn được nêu ở đây."
},
{
q: "An analyst is reviewing the property, plant, and equipment disclosure related to a company's warehouse. Under the revaluation model, the analyst would LEAST likely be able to determine:",
opts: ["the original date of acquisition", "how the fair value was obtained", "the carrying amount under the cost model"],
ans: 0,
en: "Revaluation-model disclosures require the methods and assumptions used to estimate fair value and the carrying amount that would have been reported under the cost model. The asset's original acquisition date is not a required revaluation disclosure, so it is the least likely to be determinable.",
vi: "Công bố theo revaluation model yêu cầu nêu phương pháp và giả định ước tính giá trị hợp lý và giá trị ghi sổ nếu áp dụng mô hình giá gốc. Ngày mua ban đầu của tài sản không phải công bố bắt buộc của revaluation, nên khó xác định được nhất."
},
{
q: "A crucial requirement for a central bank to be effective is to:",
opts: ["maintain reasonable inflation targets", "maintain independence from the government", "preserve the confidentiality of its economic views"],
ans: 1,
en: "Effective central banking rests on independence from political interference, along with credibility and transparency. Reasonable inflation targets help but are a policy tool, and central banks should be transparent about their views, not secretive.",
vi: "Ngân hàng trung ương hiệu quả dựa trên sự độc lập khỏi can thiệp chính trị, cùng với uy tín và minh bạch. Mục tiêu lạm phát hợp lý là hữu ích nhưng chỉ là công cụ chính sách, và ngân hàng trung ương nên minh bạch về quan điểm chứ không giữ bí mật."
},
{
q: "In ESG factor analysis, a company's ownership of stranded assets is most likely considered a(n):",
opts: ["environmental risk", "social risk", "governance risk"],
ans: 0,
en: "Stranded assets — such as fossil-fuel reserves that lose value because of the transition to a lower-carbon economy or tighter environmental regulation — are an environmental risk within ESG analysis.",
vi: "Stranded assets — như trữ lượng nhiên liệu hóa thạch mất giá trị do quá trình chuyển đổi sang nền kinh tế carbon thấp hoặc quy định môi trường siết chặt hơn — là một rủi ro môi trường trong phân tích ESG."
},
{
q: "A company's cash contribution to its defined contribution pension plan is recorded on the company's statement of cash flows as a(n):",
opts: ["operating cash outflow", "investing cash outflow", "financing cash outflow"],
ans: 0,
en: "Contributions to a defined contribution plan are a form of employee compensation, so the cash paid is classified as an operating cash outflow.",
vi: "Đóng góp vào quỹ hưu đóng góp xác định (DC) là một dạng thù lao cho nhân viên, nên tiền chi ra được phân loại là dòng tiền chi hoạt động."
},
{
q: "An analyst gathers common-size income statements for three companies in the same industry. Company X: revenue 100%, COGS 65, admin 20, R&D 0, advertising 5, operating profit 10. Company Y: revenue 100%, COGS 50, admin 20, R&D 5, advertising 15, operating profit 10. Company Z: revenue 100%, COGS 30, admin 20, R&D 30, advertising 10, operating profit 10. Which company is most likely to have a technically superior product?",
opts: ["Company X", "Company Y", "Company Z"],
ans: 2,
en: "Company Z spends by far the most on research and development (30% of revenue), the hallmark of investing in technological superiority, and its low cost of goods sold is consistent with a differentiated product. Company X spends nothing on R&D and relies on the lowest R&D with heavy reliance elsewhere.",
vi: "Company Z chi nhiều nhất cho nghiên cứu và phát triển (30% doanh thu), dấu hiệu của việc đầu tư vào ưu thế công nghệ, và giá vốn thấp phù hợp với một sản phẩm khác biệt. Company X không chi cho R&D. Vậy Company Z nhiều khả năng có sản phẩm vượt trội về kỹ thuật nhất."
},
{
q: "An analyst gathers the following about a company's fiscal year beginning 1 January: net income GBP 1,800,000; preferred dividends declared and paid GBP 600,000; common shares outstanding on 31 December 300,000; weighted average common shares 500,000; convertible preferred shares outstanding 25,000. If one preferred share converts into four common shares and there are no other dilutive securities, reported diluted EPS should be:",
opts: ["GBP 2.40", "GBP 3.00", "GBP 4.00"],
ans: 0,
en: "Basic EPS = (1,800,000 - 600,000)/500,000 = 2.40. The if-converted calculation adds back the 600,000 preferred dividend and adds 100,000 shares: 1,800,000/600,000 = 3.00. Because 3.00 exceeds basic EPS, the conversion is antidilutive and is excluded, so reported diluted EPS equals basic EPS of 2.40.",
vi: "Basic EPS = (1,800,000 - 600,000)/500,000 = 2.40. Phương pháp if-converted cộng lại 600,000 cổ tức ưu đãi và thêm 100,000 cổ phiếu: 1,800,000/600,000 = 3.00. Vì 3.00 lớn hơn basic EPS, việc chuyển đổi là antidilutive nên bị loại, và diluted EPS báo cáo bằng basic EPS 2.40."
},
{
q: "Which of the following best represents the potential for misaligned interests between shareholders and board directors when director tenures are excessively long?",
opts: ["Entrenchment", "Empire building", "Excessive risk taking"],
ans: 0,
en: "Excessively long tenure can lead to entrenchment, where directors become too comfortable and aligned with management rather than shareholders, eroding independent oversight. Empire building and excessive risk taking are management behaviors rather than tenure effects.",
vi: "Nhiệm kỳ quá dài có thể dẫn đến entrenchment, khi thành viên HĐQT trở nên quá thoải mái và nghiêng về ban lãnh đạo thay vì cổ đông, làm xói mòn giám sát độc lập. Empire building và chấp nhận rủi ro quá mức là hành vi của ban lãnh đạo hơn là hệ quả của nhiệm kỳ."
},
{
q: "Accounts payable are:",
opts: ["financial liabilities owed through a formal loan agreement", "amounts a company owes its vendors for purchases of goods and services", "reported in a different balance sheet section from notes payable due within one year"],
ans: 1,
en: "Accounts payable are amounts owed to suppliers for goods and services bought on credit, arising from ordinary operations rather than a formal loan. Notes payable due within a year are also current liabilities and appear in the same section.",
vi: "Accounts payable là khoản nợ nhà cung cấp cho hàng hóa và dịch vụ mua chịu, phát sinh từ hoạt động thông thường chứ không phải một khoản vay chính thức. Notes payable đến hạn trong một năm cũng là nợ ngắn hạn và nằm trong cùng một phần."
},
{
q: "Under IFRS, reported operating cash flows can be increased by the classification choice made for:",
opts: ["dividends paid", "interest received", "impairment losses on fixed assets"],
ans: 1,
en: "Under IFRS interest received may be classified as either operating or investing; classifying this inflow as operating raises reported operating cash flow. Impairment is a non-cash charge with no cash-flow classification effect, and while dividends paid are also flexible, the choice that adds an inflow to operations is interest received.",
vi: "Theo IFRS, lãi nhận được có thể phân loại là hoạt động kinh doanh hoặc đầu tư; xếp dòng vào này vào hoạt động kinh doanh làm tăng dòng tiền hoạt động báo cáo. Suy giảm giá trị là khoản phi tiền mặt không ảnh hưởng phân loại dòng tiền, và tuy cổ tức đã trả cũng linh hoạt, lựa chọn thêm một dòng vào cho hoạt động là lãi nhận được."
},
{
q: "A construction company enters a two-year building contract with payment due at the end when all obligations are met; costs incurred appropriately measure progress, and 30% of costs are incurred in Year 1. Assuming it is highly probable revenue will not be reversed, at the end of Year 1 the company should most likely recognize a:",
opts: ["receivable", "contract asset", "contract liability"],
ans: 1,
en: "Revenue is recognized over time as costs are incurred, but the right to payment is still conditional on completing the remaining work, so the company records a contract asset. A receivable would arise only once the right to payment becomes unconditional.",
vi: "Doanh thu được ghi nhận theo thời gian khi chi phí phát sinh, nhưng quyền nhận thanh toán vẫn phụ thuộc vào hoàn thành phần việc còn lại, nên công ty ghi nhận một contract asset. Receivable chỉ phát sinh khi quyền nhận thanh toán trở nên vô điều kiện."
},
{
q: "A company will lease machinery for five years with payments of USD 6,000 at the end of each quarter, the first due in three months. If the interest rate is 6% per year compounded quarterly, the present value of the lease payments is closest to:",
opts: ["USD 101,097", "USD 103,012", "USD 104,557"],
ans: 1,
en: "This is an ordinary annuity with a quarterly rate of 1.5% and 20 payments. PV = 6,000 x [1 - 1.015^-20]/0.015 = 6,000 x 17.169 = about USD 103,012.",
vi: "Đây là annuity thường với lãi suất quý 1.5% và 20 kỳ. PV = 6,000 x [1 - 1.015^-20]/0.015 = 6,000 x 17.169 = khoảng USD 103,012."
},
{
q: "Which of the following most likely enforces financial reporting requirements?",
opts: ["Regulatory authorities only", "Standard-setting bodies only", "Both regulatory authorities and standard-setting bodies"],
ans: 0,
en: "Standard-setting bodies such as the IASB and FASB write the accounting standards, but regulatory authorities such as securities regulators have the legal power to enforce compliance with reporting requirements.",
vi: "Các cơ quan lập chuẩn như IASB và FASB soạn ra chuẩn mực kế toán, nhưng cơ quan quản lý như các uỷ ban chứng khoán mới có quyền pháp lý cưỡng chế tuân thủ các yêu cầu báo cáo."
},
{
q: "The following data apply to a firm operating in perfect competition. Quantity 21: total revenue 210, total cost 138. Quantity 22: TR 220, TC 145. Quantity 23: TR 230, TC 154. Quantity 24: TR 240, TC 165. The firm's profit-maximizing output (in units) is most likely:",
opts: ["21", "23", "24"],
ans: 1,
en: "Profit = TR - TC: 72 at 21 units, 75 at 22, 76 at 23, and 75 at 24. Profit peaks at 23 units, which is also where marginal cost (9) is still below the 10 price before rising above it at 24.",
vi: "Lợi nhuận = TR - TC: 72 ở 21 đơn vị, 75 ở 22, 76 ở 23, và 75 ở 24. Lợi nhuận đạt đỉnh ở 23 đơn vị, cũng là nơi chi phí biên (9) còn dưới giá 10 trước khi vượt lên trên ở 24."
},
{
q: "A central bank is LEAST likely to:",
opts: ["implement fiscal policy", "oversee the payments system", "manage foreign currency reserves"],
ans: 0,
en: "Central banks conduct monetary policy, oversee the payments system, and manage foreign exchange reserves. Fiscal policy — government spending and taxation — is the responsibility of the government/treasury, not the central bank.",
vi: "Ngân hàng trung ương điều hành chính sách tiền tệ, giám sát hệ thống thanh toán, và quản lý dự trữ ngoại hối. Chính sách tài khóa — chi tiêu chính phủ và thuế — thuộc trách nhiệm của chính phủ/kho bạc, không phải ngân hàng trung ương."
},
{
q: "The possibility of new entrants into an industry is considered in the calculation of:",
opts: ["the concentration ratio", "the Herfindahl-Hirschman Index", "neither the concentration ratio nor the Herfindahl-Hirschman Index"],
ans: 2,
en: "Both the concentration ratio and the Herfindahl-Hirschman Index measure only the current market shares of existing firms. Neither incorporates the threat of new entrants or barriers to entry.",
vi: "Cả concentration ratio lẫn Herfindahl-Hirschman Index chỉ đo thị phần hiện tại của các doanh nghiệp đang tồn tại. Không chỉ số nào tính đến nguy cơ có đối thủ mới gia nhập hay rào cản gia nhập."
},
{
q: "Private companies most likely have:",
opts: ["less share price transparency compared to public companies", "similar share price transparency as public companies", "greater share price transparency compared to public companies"],
ans: 0,
en: "Private companies lack a continuously traded public market, so their shares have far less price transparency than those of public companies, whose prices are observable in real time.",
vi: "Công ty tư nhân không có thị trường giao dịch công khai liên tục, nên cổ phần của họ có tính minh bạch giá thấp hơn nhiều so với công ty đại chúng, vốn có giá quan sát được theo thời gian thực."
},
{
q: "An analyst gathers the following (in EUR thousands): purchases from suppliers 9,000; increase in inventory 1,000; increase in accounts payable 1,500. Cash paid to suppliers (in EUR thousands) is closest to:",
opts: ["7,500", "8,000", "8,500"],
ans: 0,
en: "With purchases given directly, cash paid to suppliers = purchases - increase in accounts payable = 9,000 - 1,500 = 7,500. The change in inventory is already captured within purchases and is not needed here.",
vi: "Khi đã cho trực tiếp giá trị mua hàng, tiền trả nhà cung cấp = mua hàng - mức tăng khoản phải trả = 9,000 - 1,500 = 7,500. Thay đổi tồn kho đã nằm trong mua hàng nên không cần dùng ở đây."
},
{
q: "An analyst gathers incremental after-tax cash flows (in USD millions) for three independent investments. Investment 1: -80, 0, 0, 60, 60. Investment 2: -125, 35, 60, 80, -20. Investment 3: -100 then 11 per year in perpetuity beginning Year 1. If the required rate of return is 12%, the company should most likely undertake:",
opts: ["Investment 1 only", "Investment 1 and Investment 2", "Investment 2 and Investment 3"],
ans: 0,
en: "At 12%, Investment 1 has NPV = -80 + 60/1.12^3 + 60/1.12^4 = +0.84 (accept). Investment 2 has NPV = about -1.69 (reject). Investment 3's perpetuity is 11/0.12 = 91.67, giving NPV = 91.67 - 100 = -8.33 (reject). Only Investment 1 has a positive NPV.",
vi: "Ở 12%, Investment 1 có NPV = -80 + 60/1.12^3 + 60/1.12^4 = +0.84 (nhận). Investment 2 có NPV khoảng -1.69 (loại). Perpetuity của Investment 3 là 11/0.12 = 91.67, cho NPV = 91.67 - 100 = -8.33 (loại). Chỉ Investment 1 có NPV dương."
},
{
q: "A company spends EUR 10 million on start-up costs that are expensed for accounting purposes but fully amortized straight-line over five years for tax purposes. If the start-up costs will produce future economic benefits, the tax base at the end of Year 1 is:",
opts: ["EUR 0 million", "EUR 8 million", "EUR 10 million"],
ans: 1,
en: "The tax base is the amount still deductible in the future. With straight-line tax amortization of 10/5 = 2 million per year, after Year 1 the remaining deductible amount is 10 - 2 = EUR 8 million (while the accounting carrying amount is zero).",
vi: "Tax base là số còn được khấu trừ trong tương lai. Với khấu hao thuế đường thẳng 10/5 = 2 triệu mỗi năm, sau Năm 1 số còn được khấu trừ là 10 - 2 = 8 triệu EUR (trong khi giá trị ghi sổ kế toán bằng 0)."
},
{
q: "Which list of terms is ordered from thinner to fatter tails compared with a normal distribution?",
opts: ["Mesokurtic, leptokurtic, platykurtic", "Platykurtic, mesokurtic, leptokurtic", "Leptokurtic, mesokurtic, platykurtic"],
ans: 1,
en: "Platykurtic distributions have thinner tails than the normal, mesokurtic match the normal, and leptokurtic have fatter tails. Ordered from thinner to fatter, that is platykurtic, mesokurtic, leptokurtic.",
vi: "Phân phối platykurtic có đuôi mỏng hơn phân phối chuẩn, mesokurtic bằng chuẩn, và leptokurtic có đuôi dày hơn. Xếp từ mỏng đến dày là platykurtic, mesokurtic, leptokurtic."
},
{
q: "The archetype of country behavior most likely characterized by globalization and cooperation is:",
opts: ["hegemony", "bilateralism", "multilateralism"],
ans: 2,
en: "Multilateralism, in which many countries cooperate through shared institutions and agreements, is the archetype associated with globalization and cooperation. Bilateralism involves just two countries, and hegemony reflects the dominance of one power.",
vi: "Multilateralism, khi nhiều quốc gia hợp tác qua các thể chế và thỏa thuận chung, là hình mẫu gắn với toàn cầu hóa và hợp tác. Bilateralism chỉ liên quan hai nước, và hegemony phản ánh sự thống trị của một cường quốc."
},
{
q: "With respect to Porter's five forces analysis, which of the following best describes government policies?",
opts: ["They are viewed as a sixth force", "They are ignored because they affect all companies in the industry", "They are analyzed to understand how they affect the five competitive forces"],
ans: 2,
en: "In Porter's framework government is not treated as a separate force. Instead, its policies are analyzed for how they shape the intensity of the five existing forces, such as barriers to entry or supplier and buyer power.",
vi: "Trong khung của Porter, chính phủ không được xem là một lực riêng. Thay vào đó, chính sách của chính phủ được phân tích xem chúng định hình cường độ của năm lực hiện có ra sao, chẳng hạn rào cản gia nhập hay sức mạnh của nhà cung cấp và người mua."
},
{
q: "An analyst gathers the following (in USD millions): average total assets 50; average total liabilities 30. The financial leverage ratio is closest to:",
opts: ["0.6", "1.5", "2.5"],
ans: 2,
en: "The financial leverage ratio = average total assets/average total equity. Equity = 50 - 30 = 20, so the ratio = 50/20 = 2.5.",
vi: "Financial leverage ratio = tổng tài sản bình quân/vốn chủ bình quân. Vốn chủ = 50 - 30 = 20, nên tỷ số = 50/20 = 2.5."
},
{
q: "A primary aim of fiscal policy is to manage the economy through its influence on:",
opts: ["real GDP", "price stability", "interest rates"],
ans: 0,
en: "Fiscal policy uses government spending and taxation to influence aggregate demand and therefore real GDP, output, and employment. Price stability and interest rates are primarily the domain of monetary policy.",
vi: "Chính sách tài khóa dùng chi tiêu chính phủ và thuế để tác động tổng cầu và do đó GDP thực, sản lượng và việc làm. Ổn định giá cả và lãi suất chủ yếu thuộc phạm vi của chính sách tiền tệ."
},
{
q: "An analyst gathers the following: before-tax cost of debt 5%; marginal tax rate 30%; cost of equity 8%; target debt-to-equity ratio 50%. The company's WACC is closest to:",
opts: ["5.75%", "6.50%", "7.00%"],
ans: 1,
en: "A D/E of 0.50 gives weights wD = 0.50/1.50 = 0.3333 and wE = 1/1.50 = 0.6667. WACC = 0.3333(5%)(1 - 0.30) + 0.6667(8%) = 1.167% + 5.333% = 6.50%.",
vi: "D/E 0.50 cho trọng số wD = 0.50/1.50 = 0.3333 và wE = 1/1.50 = 0.6667. WACC = 0.3333(5%)(1 - 0.30) + 0.6667(8%) = 1.167% + 5.333% = 6.50%."
},
{
q: "If the relationship between the dependent variable and the independent variable is linear, the regression residuals plotted against the independent variable should appear to:",
opts: ["be linear", "be random", "follow a pattern"],
ans: 1,
en: "When the linear model is correctly specified, the residuals should scatter randomly around zero with no discernible pattern. A systematic pattern in the residuals would signal that the linear specification is inadequate.",
vi: "Khi mô hình tuyến tính được đặc tả đúng, phần dư nên phân tán ngẫu nhiên quanh 0 mà không có khuôn mẫu rõ ràng. Một khuôn mẫu có hệ thống trong phần dư sẽ báo hiệu đặc tả tuyến tính chưa phù hợp."
}
]
});

window.CFA.mocktests.push({
name: "Mock Exam 5 — Session 2 (FI · Equity · Derivatives · Alternatives · PM)",
qs: [
{
q: "When a company has significant intangibles, asset-based valuation is most likely:",
opts: ["used to determine the value of off-the-books assets", "less preferred than forward-looking cash flow valuation", "appropriate to calculate a maximum value for the company"],
ans: 1,
en: "Asset-based valuation relies on the fair value of a company's assets and liabilities, which is unreliable when much of the value comes from hard-to-measure intangibles. In that case forward-looking cash-flow-based approaches are preferred.",
vi: "Định giá dựa trên tài sản dựa vào giá trị hợp lý của tài sản và nợ, vốn kém tin cậy khi phần lớn giá trị đến từ tài sản vô hình khó đo lường. Khi đó, các phương pháp dựa trên dòng tiền hướng tới tương lai được ưu tiên hơn."
},
{
q: "The lead underwriter in an IPO most likely:",
opts: ["acts as the book builder for the offering", "is not responsible for making a market in the securities", "is prohibited from providing an opinion about the issue to its clients"],
ans: 0,
en: "The lead underwriter builds the book of investor demand that sets the offering price and allocation. It typically also makes a market in the shares afterward and may provide research opinions to clients.",
vi: "Nhà bảo lãnh chính xây dựng sổ cầu (book) của nhà đầu tư để định giá phát hành và phân bổ. Họ thường cũng tạo lập thị trường cho cổ phiếu sau đó và có thể cung cấp ý kiến nghiên cứu cho khách hàng."
},
{
q: "The value of a European put option is directly (positively) related to the:",
opts: ["risk-free interest rate", "value of the underlying", "volatility of the underlying"],
ans: 2,
en: "A put becomes more valuable as volatility rises. It is inversely related to both the value of the underlying (a higher price makes the put less likely to finish in the money) and, for a European put, the risk-free rate.",
vi: "Quyền chọn bán có giá trị hơn khi biến động tăng. Nó có quan hệ nghịch với cả giá tài sản cơ sở (giá cao hơn làm quyền chọn bán ít khả năng có lãi) và, với quyền chọn bán kiểu châu Âu, với lãi suất phi rủi ro."
},
{
q: "If it is difficult to find a buyer or a seller for an asset, the asset most likely trades in:",
opts: ["brokered markets", "order-driven markets", "quote-driven markets"],
ans: 0,
en: "Brokered markets are used for unique or illiquid assets where a broker must actively search out a counterparty. Order-driven and quote-driven markets suit more liquid, frequently traded securities.",
vi: "Thị trường qua môi giới (brokered) dùng cho tài sản độc nhất hoặc kém thanh khoản, nơi môi giới phải chủ động tìm đối tác. Thị trường theo lệnh và theo báo giá phù hợp với chứng khoán thanh khoản, giao dịch thường xuyên hơn."
},
{
q: "Which of the following is most likely a consequence of the overconfidence bias? An investor who:",
opts: ["overestimates downside risks", "underestimates expected returns", "holds a poorly diversified portfolio"],
ans: 2,
en: "Overconfident investors overestimate their own insight, trade too much, and concentrate holdings in their favored ideas, leaving them poorly diversified. They tend to underestimate — not overestimate — risk.",
vi: "Nhà đầu tư quá tự tin đánh giá quá cao hiểu biết của mình, giao dịch quá nhiều, và tập trung nắm giữ vào các ý tưởng ưa thích, khiến danh mục ít đa dạng hóa. Họ có xu hướng đánh giá thấp — chứ không phải cao — rủi ro."
},
{
q: "Forward contracts differ from futures contracts because forwards are:",
opts: ["standardized", "marked to market", "traded over-the-counter"],
ans: 2,
en: "Forwards are customized, privately negotiated over-the-counter contracts that are not marked to market daily. Futures are standardized, exchange-traded, and marked to market each day.",
vi: "Forward là hợp đồng OTC được đàm phán riêng, tùy chỉnh và không được đánh giá lại theo thị trường hằng ngày. Futures được chuẩn hóa, giao dịch trên sàn và được đánh giá lại theo thị trường mỗi ngày."
},
{
q: "The market model is most likely used to predict:",
opts: ["market returns in a future period", "economic growth in a future period", "company-specific returns in a future period"],
ans: 2,
en: "The market model, Ri = alpha_i + beta_i x Rm + error, estimates the expected return of an individual security given the market return, so it is used to predict company-specific returns.",
vi: "Market model, Ri = alpha_i + beta_i x Rm + sai số, ước tính lợi suất kỳ vọng của một chứng khoán riêng lẻ dựa trên lợi suất thị trường, nên được dùng để dự báo lợi suất riêng của công ty."
},
{
q: "Which ESG investment approach best describes positive screening?",
opts: ["Systematic consideration of material ESG factors in asset allocation", "Inclusion of sectors or companies in the portfolio based on specific ESG criteria", "Investments made with the intention to generate positive, measurable social and environmental impact"],
ans: 1,
en: "Positive screening includes companies or sectors that rank well against chosen ESG criteria (best-in-class). Systematic consideration of ESG factors is integration, and seeking measurable social impact is impact investing.",
vi: "Positive screening đưa vào các công ty hoặc ngành đạt tiêu chí ESG đã chọn (best-in-class). Cân nhắc yếu tố ESG một cách hệ thống là integration, và tìm kiếm tác động xã hội đo lường được là impact investing."
},
{
q: "Which of the following is most likely undertaken during the risk budgeting process?",
opts: ["Assessing risk appetite", "Setting a limit for value at risk (VaR)", "Establishing a reserve to cover potential future losses"],
ans: 1,
en: "Risk budgeting allocates an organization's total risk appetite across activities, for example by setting a VaR limit. Assessing overall risk appetite is a governance step that precedes budgeting.",
vi: "Risk budgeting phân bổ tổng mức chấp nhận rủi ro của tổ chức cho các hoạt động, chẳng hạn bằng cách đặt giới hạn VaR. Đánh giá tổng thể khẩu vị rủi ro là bước quản trị đứng trước việc phân bổ."
},
{
q: "An 8-year, 3.5% annual coupon bond is priced at 92.1492 with a yield to maturity of 4.7% and a Macaulay duration of 7.0705. If rates decrease by 75 basis points, the percentage price change of the bond is closest to:",
opts: ["-5.30%", "5.07%", "5.30%"],
ans: 1,
en: "Modified duration = Macaulay duration/(1 + YTM) = 7.0705/1.047 = 6.753. The estimated price change = -modified duration x change in yield = -6.753 x (-0.0075) = +5.07%.",
vi: "Modified duration = Macaulay duration/(1 + YTM) = 7.0705/1.047 = 6.753. Thay đổi giá ước tính = -modified duration x thay đổi lợi suất = -6.753 x (-0.0075) = +5.07%."
},
{
q: "An analyst gathers the following (in USD thousands). Operating income: Year 1 255, Year 2 234. Depreciation and amortization: Year 1 432, Year 2 677. Interest expense: Year 1 170, Year 2 156. Based on the EBITDA interest coverage ratio, the company's creditworthiness has:",
opts: ["deteriorated", "remained unchanged", "improved"],
ans: 2,
en: "EBITDA = operating income + depreciation and amortization. Year 1 coverage = (255 + 432)/170 = 4.04; Year 2 = (234 + 677)/156 = 5.84. Higher coverage means creditworthiness has improved.",
vi: "EBITDA = lợi nhuận hoạt động + khấu hao. Coverage Năm 1 = (255 + 432)/170 = 4.04; Năm 2 = (234 + 677)/156 = 5.84. Coverage cao hơn nghĩa là mức độ tín nhiệm được cải thiện."
},
{
q: "A correlation matrix for securities A, B, and C shows: correlation(A,B) = 0.5; correlation(A,C) = 0; correlation(B,C) = -0.5. Assuming equal expected return and standard deviation for each security, an equal allocation to which two securities is most effective for diversification?",
opts: ["Securities A and B", "Securities A and C", "Securities B and C"],
ans: 2,
en: "Diversification is most effective when the two assets have the lowest (most negative) correlation. Securities B and C have a correlation of -0.5, the lowest of the pairs, giving the greatest risk reduction.",
vi: "Đa dạng hóa hiệu quả nhất khi hai tài sản có tương quan thấp nhất (âm nhất). Chứng khoán B và C có tương quan -0.5, thấp nhất trong các cặp, nên giảm rủi ro nhiều nhất."
},
{
q: "An analyst gathers the following about a putable bond currently trading at par. Price per 100 of par: 102.25 at -25 bps; 100.00 unchanged; 99.25 at +25 bps. The effective duration of this bond is:",
opts: ["1.5", "4.5", "6.0"],
ans: 2,
en: "Effective duration = (V- - V+)/(2 x V0 x change in yield) = (102.25 - 99.25)/(2 x 100 x 0.0025) = 3.00/0.5 = 6.0.",
vi: "Effective duration = (V- - V+)/(2 x V0 x thay đổi lợi suất) = (102.25 - 99.25)/(2 x 100 x 0.0025) = 3.00/0.5 = 6.0."
},
{
q: "A private equity firm sells a portfolio company to a buyer that is active in the same industry as the portfolio company. This transaction is best described as a(n):",
opts: ["trade sale", "secondary sale", "initial public offering"],
ans: 0,
en: "Selling a portfolio company to a strategic buyer operating in the same industry is a trade sale. A secondary sale is a sale to another financial sponsor, and an IPO sells shares to public investors.",
vi: "Bán công ty trong danh mục cho một bên mua chiến lược hoạt động cùng ngành là trade sale. Secondary sale là bán cho một nhà tài trợ tài chính khác, còn IPO bán cổ phần cho nhà đầu tư đại chúng."
},
{
q: "Key rate duration:",
opts: ["requires the shape of the benchmark yield curve to stay constant", "measures a bond's sensitivity to a change in the benchmark yield at a specific maturity", "indicates the same interest rate sensitivity as effective duration for non-parallel shifts in the yield curve"],
ans: 1,
en: "Key rate duration measures price sensitivity to a change in the benchmark yield at one specific maturity point, holding other maturities fixed, which is exactly what lets it capture non-parallel shifts. Effective duration assumes parallel shifts.",
vi: "Key rate duration đo độ nhạy của giá với thay đổi lợi suất chuẩn tại một điểm kỳ hạn cụ thể, giữ các kỳ hạn khác cố định, chính điều đó cho phép nó nắm bắt dịch chuyển không song song. Effective duration giả định dịch chuyển song song."
},
{
q: "Which natural resource has formed part of large institutional portfolios for decades?",
opts: ["Farmland only", "Timberland only", "Both farmland and timberland"],
ans: 2,
en: "Both farmland and timberland have long histories as institutional real-asset investments, valued for income, diversification, and inflation protection.",
vi: "Cả farmland và timberland đều có lịch sử lâu đời như các khoản đầu tư tài sản thực của tổ chức, được ưa chuộng vì thu nhập, đa dạng hóa và phòng ngừa lạm phát."
},
{
q: "According to put-call parity, a long position in an underlying is equivalent to a long risk-free bond combined with a:",
opts: ["long call and a long put with the same strike", "long call and a short put with the same strike", "short call and a long put with the same strike"],
ans: 1,
en: "Put-call parity, S + p = c + PV(X), rearranges to S = c - p + PV(X). So a long underlying equals a long risk-free bond plus a long call and a short put with the same strike.",
vi: "Put-call parity, S + p = c + PV(X), biến đổi thành S = c - p + PV(X). Vậy vị thế mua tài sản cơ sở bằng một trái phiếu phi rủi ro cộng một quyền chọn mua và một quyền chọn bán bán khống cùng giá thực hiện."
},
{
q: "An investor values a company using the dividend discount model. All else equal, the estimated intrinsic value of the stock for a one-year holding period is most likely:",
opts: ["lower than for a five-year holding period", "equal to that for a five-year holding period", "higher than for a five-year holding period"],
ans: 1,
en: "A stock's intrinsic value does not depend on the investor's holding period. For a one-year horizon the terminal sale price already embeds the value of all future dividends, so the estimate equals that of a five-year horizon.",
vi: "Giá trị nội tại của cổ phiếu không phụ thuộc vào thời gian nắm giữ của nhà đầu tư. Với kỳ một năm, giá bán cuối kỳ đã hàm chứa giá trị của mọi cổ tức tương lai, nên ước tính bằng với kỳ năm năm."
},
{
q: "Private real estate investors expect to generate the highest returns from:",
opts: ["core strategies", "value-add strategies", "opportunistic strategies"],
ans: 2,
en: "Opportunistic strategies — development, redevelopment, and distressed assets — carry the most risk and the highest expected returns. Core strategies are the lowest risk and lowest expected return.",
vi: "Chiến lược opportunistic — phát triển, tái phát triển và tài sản khó khăn — mang rủi ro cao nhất và lợi suất kỳ vọng cao nhất. Chiến lược core có rủi ro và lợi suất kỳ vọng thấp nhất."
},
{
q: "An investor purchased a 5-year bond at issuance for 98 per 100 of par and held it for two years, reinvesting coupons at the original YTM. If the realized horizon yield equals the original YTM, the investor most likely sold the bond at a price:",
opts: ["below par", "equal to par", "above par"],
ans: 0,
en: "A price of 98 means the bond was issued at a discount, so its coupon is below the YTM. As it approaches maturity the price pulls toward par but remains below par with three years still remaining, so the sale price is below par.",
vi: "Giá 98 nghĩa là trái phiếu phát hành với chiết khấu, nên coupon thấp hơn YTM. Khi đến gần đáo hạn, giá kéo về mệnh giá nhưng vẫn dưới par khi còn ba năm, nên giá bán dưới par."
},
{
q: "For portfolios composed of the risk-free asset and a risky asset, the expected return as a function of the standard deviation of returns is graphically represented by the:",
opts: ["security market line", "capital allocation line", "Markowitz efficient frontier"],
ans: 1,
en: "Combining the risk-free asset with a single risky asset traces a straight line in return-standard deviation space, the capital allocation line. The security market line plots expected return against beta.",
vi: "Kết hợp tài sản phi rủi ro với một tài sản rủi ro tạo thành một đường thẳng trong không gian lợi suất-độ lệch chuẩn, đó là capital allocation line. Security market line vẽ lợi suất kỳ vọng theo beta."
},
{
q: "An investor gathers: most recent dividend per share USD 1.47; next year's estimated EPS USD 4.00; long-run ROE 15%; long-run dividend payout ratio 40%; required return 12%. The company's justified forward P/E is closest to:",
opts: ["10.0", "13.3", "20.0"],
ans: 1,
en: "Growth g = retention x ROE = 0.60 x 0.15 = 0.09. Justified forward P/E = payout/(r - g) = 0.40/(0.12 - 0.09) = 0.40/0.03 = 13.3.",
vi: "Tăng trưởng g = tỷ lệ giữ lại x ROE = 0.60 x 0.15 = 0.09. Justified forward P/E = payout/(r - g) = 0.40/(0.12 - 0.09) = 0.40/0.03 = 13.3."
},
{
q: "Which category of private debt most likely has the highest level of risk for an investor?",
opts: ["Mezzanine debt", "Senior direct debt", "Infrastructure debt"],
ans: 0,
en: "Mezzanine debt is subordinated, ranking below senior claims, so it bears the highest risk (and highest expected return). Senior direct lending and infrastructure debt sit higher in the capital structure.",
vi: "Mezzanine debt là nợ thứ cấp, đứng dưới các quyền đòi ưu tiên, nên chịu rủi ro cao nhất (và lợi suất kỳ vọng cao nhất). Cho vay trực tiếp ưu tiên và nợ hạ tầng nằm cao hơn trong cấu trúc vốn."
},
{
q: "A 5% decline in the value of a security held on margin reduces an investor's equity value by 20%. After the price decline, the leverage ratio of the position is:",
opts: ["4.00", "4.75", "5.00"],
ans: 1,
en: "A 20% equity change from a 5% price change implies an initial leverage ratio of 4. With a 100 position, equity is 25 and borrowing 75; after the 5% fall the position is 95 and equity 20, so the new leverage ratio = 95/20 = 4.75.",
vi: "Thay đổi vốn chủ 20% từ thay đổi giá 5% hàm ý leverage ban đầu là 4. Với vị thế 100, vốn chủ 25 và vay 75; sau khi giảm 5%, vị thế còn 95 và vốn chủ 20, nên leverage mới = 95/20 = 4.75."
},
{
q: "A closed-end fund is trading at a premium to its NAV. This scenario most likely reflects:",
opts: ["concerns about the quality of management", "excess demand for redemption of the shares", "a belief that the portfolio securities are undervalued"],
ans: 2,
en: "A premium reflects investor optimism — a belief that the fund's holdings are worth more than the stated NAV. Concerns about management push funds to a discount, and closed-end funds do not offer redemptions.",
vi: "Mức phụ trội (premium) phản ánh sự lạc quan của nhà đầu tư — niềm tin rằng danh mục của quỹ đáng giá hơn NAV công bố. Lo ngại về ban quản lý đẩy quỹ về mức chiết khấu, và quỹ đóng không cho phép mua lại."
},
{
q: "Which US sovereign security is a pure discount bond?",
opts: ["Treasury bill", "Treasury note", "Treasury bond"],
ans: 0,
en: "Treasury bills are zero-coupon, pure discount instruments issued below par and redeemed at par. Treasury notes and bonds pay periodic coupons.",
vi: "Treasury bill là công cụ chiết khấu thuần túy, không coupon, phát hành dưới mệnh giá và hoàn trả bằng mệnh giá. Treasury note và bond trả coupon định kỳ."
},
{
q: "An analyst gathers: earnings retention rate 55%; ROE 20%; required return 15%. The justified forward P/E is closest to:",
opts: ["7.5", "11.3", "13.8"],
ans: 1,
en: "Growth g = retention x ROE = 0.55 x 0.20 = 0.11, and the payout ratio = 0.45. Justified forward P/E = payout/(r - g) = 0.45/(0.15 - 0.11) = 0.45/0.04 = 11.3.",
vi: "Tăng trưởng g = tỷ lệ giữ lại x ROE = 0.55 x 0.20 = 0.11, và payout = 0.45. Justified forward P/E = payout/(r - g) = 0.45/(0.15 - 0.11) = 0.45/0.04 = 11.3."
},
{
q: "The pass-through rate of a mortgage pass-through security is:",
opts: ["lower than the mortgage rate on the underlying pool", "equal to the mortgage rate on the underlying pool", "greater than the mortgage rate on the underlying pool"],
ans: 0,
en: "The pass-through rate paid to investors is lower than the weighted average mortgage rate of the pool because servicing and guarantee fees are deducted before cash flows reach investors.",
vi: "Lãi suất chuyển giao (pass-through) trả cho nhà đầu tư thấp hơn lãi suất bình quân của rổ thế chấp vì phí quản lý (servicing) và phí bảo lãnh được trừ trước khi dòng tiền đến nhà đầu tư."
},
{
q: "Consider a call option trading for USD 2.00 with an exercise price of USD 38.00. If the price of the underlying at expiration is USD 42.00, the payoff for the call option seller is:",
opts: ["-USD 4.00", "-USD 2.00", "USD 4.00"],
ans: 0,
en: "The call buyer's payoff = max(0, 42 - 38) = 4.00, so the seller's payoff is the mirror image, -4.00. (The seller's profit, netting the 2.00 premium received, would be -2.00, but the question asks for payoff.)",
vi: "Payoff của người mua call = max(0, 42 - 38) = 4.00, nên payoff của người bán là đối xứng, -4.00. (Lợi nhuận của người bán, sau khi trừ phí 2.00 đã nhận, sẽ là -2.00, nhưng câu hỏi hỏi payoff.)"
},
{
q: "A credit issuer rating assigned by a rating agency is based on:",
opts: ["the notching adjustment of a specific bond of the issuer", "the ranking of a specific bond in the issuer's capital structure", "the issuer's ability and willingness to service its senior unsecured debt"],
ans: 2,
en: "An issuer (corporate family) rating reflects the borrower's overall ability and willingness to service its senior unsecured obligations. Notching then adjusts individual issues up or down based on their ranking in the capital structure.",
vi: "Xếp hạng nhà phát hành (corporate family) phản ánh khả năng và thiện chí tổng thể của bên vay trong việc trả nợ ưu tiên không bảo đảm. Notching sau đó điều chỉnh từng đợt phát hành lên hoặc xuống theo thứ hạng trong cấu trúc vốn."
},
{
q: "The price sensitivity of a bond to a change in the benchmark yield curve is the:",
opts: ["effective duration", "modified duration", "Macaulay duration"],
ans: 0,
en: "Effective duration measures a bond's price sensitivity to a shift in the benchmark yield curve and is the appropriate measure for bonds with embedded options. Modified and Macaulay durations assume fixed cash flows and a change in the bond's own yield.",
vi: "Effective duration đo độ nhạy giá của trái phiếu với dịch chuyển đường cong lợi suất chuẩn và là thước đo phù hợp cho trái phiếu có quyền chọn gắn kèm. Modified và Macaulay duration giả định dòng tiền cố định và thay đổi lợi suất của chính trái phiếu."
},
{
q: "A transaction set up to absorb the variable cash flow of a floating-rate asset can best be described as a:",
opts: ["fair value hedge", "cash flow hedge", "net investment hedge"],
ans: 1,
en: "Hedging the variability of future cash flows, such as those from a floating-rate asset, is a cash flow hedge. A fair value hedge protects the value of a fixed item, and a net investment hedge covers a foreign operation.",
vi: "Phòng ngừa biến động của dòng tiền tương lai, như từ một tài sản lãi suất thả nổi, là cash flow hedge. Fair value hedge bảo vệ giá trị của một khoản mục cố định, và net investment hedge bảo vệ một hoạt động ở nước ngoài."
},
{
q: "Measuring the duration of a bond portfolio as a weighted average of the individual bond durations:",
opts: ["is difficult to use as a measure of interest rate risk", "assumes the yield curve shifts in a parallel manner", "assumes the yield curve shifts in a non-parallel manner"],
ans: 1,
en: "The weighted-average approach to portfolio duration assumes every bond's yield changes by the same amount, that is, a parallel shift in the yield curve. It is simple and widely used, not difficult.",
vi: "Cách tính duration danh mục theo bình quân gia quyền giả định lợi suất của mọi trái phiếu thay đổi cùng một lượng, tức dịch chuyển song song của đường cong lợi suất. Nó đơn giản và được dùng phổ biến, không khó."
},
{
q: "An analyst gathers the following (in USD millions) about a private equity fund. Investment A: initial cost 100, profit/loss -50. Investment B: initial cost 150, profit/loss 30. If the incentive fee is 20% of profits and no clawback applies, the total incentive fee under an American-style waterfall is:",
opts: ["-4", "0", "6"],
ans: 2,
en: "An American (deal-by-deal) waterfall charges the incentive fee on each profitable deal separately. Investment A's loss generates no fee, while Investment B's 30 profit yields 0.20 x 30 = 6, for a total of 6.",
vi: "Waterfall kiểu Mỹ (từng thương vụ) tính phí thưởng trên từng thương vụ có lãi riêng biệt. Khoản lỗ của Investment A không phát sinh phí, trong khi lãi 30 của Investment B cho 0.20 x 30 = 6, tổng cộng là 6."
},
{
q: "Selected information about two stocks: Cable Inc. standard deviation 30%, portfolio weight 68%; GPT Co. standard deviation 20%, portfolio weight 32%; correlation between them 0.65. The standard deviation of the portfolio formed with these two stocks is closest to:",
opts: ["25.04%", "26.80%", "32.85%"],
ans: 0,
en: "Portfolio variance = 0.68^2(30^2) + 0.32^2(20^2) + 2(0.68)(0.32)(0.65)(30)(20) = 416.16 + 40.96 + 169.73 = 626.85. The square root is about 25.04%.",
vi: "Phương sai danh mục = 0.68^2(30^2) + 0.32^2(20^2) + 2(0.68)(0.32)(0.65)(30)(20) = 416.16 + 40.96 + 169.73 = 626.85. Căn bậc hai xấp xỉ 25.04%."
},
{
q: "Market prices are most likely accepted as accurately reflecting intrinsic values in:",
opts: ["an inefficient market only", "a highly efficient market only", "both an inefficient market and a highly efficient market"],
ans: 1,
en: "Only in a highly efficient market do prices quickly and fully reflect available information, so market price approximates intrinsic value. In an inefficient market, prices can deviate meaningfully from intrinsic value.",
vi: "Chỉ trong thị trường hiệu quả cao, giá mới phản ánh nhanh và đầy đủ thông tin sẵn có, nên giá thị trường xấp xỉ giá trị nội tại. Trong thị trường kém hiệu quả, giá có thể lệch đáng kể so với giá trị nội tại."
},
{
q: "Sponsored depository receipts are most likely subject to:",
opts: ["less reporting requirements than unsponsored ones", "the same level of reporting requirements as unsponsored ones", "greater reporting requirements than unsponsored ones"],
ans: 2,
en: "In a sponsored program the foreign company is directly involved and registers the receipts, so sponsored depository receipts carry greater reporting and disclosure requirements than unsponsored ones.",
vi: "Trong chương trình có bảo trợ, công ty nước ngoài tham gia trực tiếp và đăng ký chứng chỉ, nên depository receipt có bảo trợ chịu yêu cầu báo cáo và công bố lớn hơn loại không bảo trợ."
},
{
q: "All else equal, which condition most likely results in wider credit spreads?",
opts: ["A credit cycle peak", "A strengthening economy", "A period of heavy new issue supply"],
ans: 2,
en: "A surge of new issuance forces issuers to offer more yield to place bonds, widening spreads. A credit cycle peak and a strengthening economy both tend to narrow spreads.",
vi: "Một làn sóng phát hành mới buộc nhà phát hành phải chào lợi suất cao hơn để bán được trái phiếu, làm nới rộng spread. Đỉnh chu kỳ tín dụng và nền kinh tế mạnh lên đều có xu hướng thu hẹp spread."
},
{
q: "Which of the following is most likely an application of the CAPM?",
opts: ["Estimating expected returns over multiple periods", "Assessing return performance against a benchmark", "Estimating expected returns using multiple investment factors"],
ans: 1,
en: "The CAPM provides an expected-return benchmark against which realized performance can be judged (for example via alpha). It is a single-period, single-factor model, so multiple periods and multiple factors are outside its scope.",
vi: "CAPM cung cấp một mốc lợi suất kỳ vọng để đánh giá hiệu suất thực tế (ví dụ qua alpha). Nó là mô hình một kỳ, một nhân tố, nên nhiều kỳ và nhiều nhân tố nằm ngoài phạm vi của nó."
},
{
q: "Which statement about market efficiency is most accurate? In a:",
opts: ["weak-form efficient market, technical analysis generates abnormal returns over the long run", "semi-strong-form efficient market, active portfolio managers outperform the market consistently", "strong-form efficient market, insiders would not be able to earn abnormal returns from trading on private information"],
ans: 2,
en: "Strong-form efficiency means prices reflect all information, public and private, so even insiders cannot earn abnormal returns. Weak-form efficiency defeats technical analysis, and semi-strong efficiency prevents consistent outperformance using public information.",
vi: "Hiệu quả dạng mạnh nghĩa là giá phản ánh mọi thông tin, công khai và riêng tư, nên ngay cả người nội bộ cũng không thể kiếm lợi bất thường. Hiệu quả dạng yếu vô hiệu hóa phân tích kỹ thuật, và hiệu quả bán mạnh ngăn việc vượt trội liên tục nhờ thông tin công khai."
},
{
q: "If the 1-year spot rate is 3% and the 2-year spot rate is 4.5%, the 1y1y implied forward rate is closest to:",
opts: ["1.46%", "3.75%", "6.02%"],
ans: 2,
en: "Using (1 + 2-year spot)^2 = (1 + 1-year spot)(1 + forward): (1.045)^2 = (1.03)(1 + f), so 1 + f = 1.092025/1.03 = 1.0602, giving f = 6.02%.",
vi: "Dùng (1 + spot 2 năm)^2 = (1 + spot 1 năm)(1 + forward): (1.045)^2 = (1.03)(1 + f), nên 1 + f = 1.092025/1.03 = 1.0602, cho f = 6.02%."
},
{
q: "Exercise of a European put option is most likely justified if:",
opts: ["the option is out of the money", "the exercise value is negative", "the exercise price exceeds the value of the underlying"],
ans: 2,
en: "A put is worth exercising when it is in the money, that is, when the exercise price exceeds the value of the underlying so the payoff (X - S) is positive. An out-of-the-money option or a negative exercise value would not justify exercise.",
vi: "Quyền chọn bán đáng thực hiện khi nó có lãi (in the money), tức khi giá thực hiện vượt giá trị tài sản cơ sở nên payoff (X - S) dương. Quyền chọn ngoài giá hay giá trị thực hiện âm thì không đáng thực hiện."
},
{
q: "If a stock purchased with 60% margin declines 25%, the investor's return on equity is closest to:",
opts: ["-85%", "-63%", "-42%"],
ans: 2,
en: "With 60% initial margin, a 100 position uses 60 of equity and 40 of borrowing. A 25% decline cuts the position to 75, a loss of 25, so the return on equity is -25/60 = -42% (ignoring interest).",
vi: "Với ký quỹ ban đầu 60%, vị thế 100 dùng 60 vốn chủ và 40 vay. Giảm 25% đưa vị thế về 75, lỗ 25, nên lợi suất trên vốn chủ là -25/60 = -42% (bỏ qua lãi vay)."
},
{
q: "Do management fees get paid to the manager of a hedge fund regardless of the fund's performance?",
opts: ["Yes", "No, only when the fund's gross return is positive", "No, only when the fund's net asset value exceeds the previous high-water mark"],
ans: 0,
en: "Management fees are charged on assets under management and are paid regardless of performance. Performance depends on the incentive fee, which is where the gross return and high-water mark conditions apply.",
vi: "Phí quản lý được tính trên tài sản quản lý và được trả bất kể hiệu suất. Hiệu suất liên quan đến phí thưởng, nơi các điều kiện về lợi suất gộp và high-water mark mới áp dụng."
},
{
q: "Which equation best describes put-call parity for European options?",
opts: ["p0 = c0 - S0 + X/(1 + r)^T", "c0 = p0 - S0 - X/(1 + r)^T", "S0 = c0 - p0 - X/(1 + r)^T"],
ans: 0,
en: "Put-call parity states c0 + X/(1 + r)^T = p0 + S0. Solving for the put gives p0 = c0 - S0 + X/(1 + r)^T.",
vi: "Put-call parity nêu c0 + X/(1 + r)^T = p0 + S0. Giải theo quyền chọn bán cho p0 = c0 - S0 + X/(1 + r)^T."
},
{
q: "In the binomial option pricing model, the price of a call option will increase when:",
opts: ["the risk-free rate increases", "the volatility of the underlying increases", "the probability of an upward movement in the underlying increases"],
ans: 0,
en: "In the binomial framework a higher risk-free rate raises the risk-neutral probability of an up move and hence the call value. Crucially, the actual (real-world) probability of an up move does not affect the option price, since valuation uses risk-neutral probabilities.",
vi: "Trong khung nhị thức, lãi suất phi rủi ro cao hơn làm tăng xác suất trung tính rủi ro của bước tăng và do đó tăng giá call. Quan trọng là xác suất thực (thế giới thực) của bước tăng không ảnh hưởng giá quyền chọn, vì định giá dùng xác suất trung tính rủi ro."
},
{
q: "Issuers' disclosures about operating costs are most likely:",
opts: ["less detailed than their revenue disclosures", "just as detailed as their revenue disclosures", "more detailed than their revenue disclosures"],
ans: 0,
en: "Companies generally provide less granular disclosure about costs than about revenue, where recognition policies and disaggregation requirements are more extensive.",
vi: "Doanh nghiệp nhìn chung công bố về chi phí ít chi tiết hơn so với doanh thu, nơi các chính sách ghi nhận và yêu cầu chi tiết hóa rộng hơn."
},
{
q: "The industry growth style of the crude oil sector is best characterized as:",
opts: ["cyclical mature", "defensive growth", "defensive mature"],
ans: 0,
en: "Crude oil demand and prices move strongly with the economic cycle, and the sector is well established, so it is best described as cyclical and mature.",
vi: "Cầu và giá dầu thô biến động mạnh theo chu kỳ kinh tế, và ngành đã phát triển ổn định, nên được mô tả tốt nhất là cyclical và mature."
},
{
q: "In which section of an IPS is the rebalancing policy most likely found?",
opts: ["Appendices", "Investment Guidelines", "Evaluation and Review"],
ans: 0,
en: "The strategic asset allocation and the rebalancing policy are typically placed in the appendices of the investment policy statement.",
vi: "Phân bổ tài sản chiến lược và chính sách tái cân bằng thường được đặt trong phần phụ lục (appendices) của bản tuyên bố chính sách đầu tư."
},
{
q: "For a given currency and tenor, a bond's yield spread over the standard swap rate is best described as the:",
opts: ["I-spread", "G-spread", "Z-spread"],
ans: 0,
en: "The I-spread (interpolated spread) is a bond's yield over the relevant maturity-matched swap rate. The G-spread is measured over a government bond, and the Z-spread is a constant spread over the entire spot curve.",
vi: "I-spread (spread nội suy) là lợi suất của trái phiếu so với lãi suất swap khớp kỳ hạn tương ứng. G-spread đo so với trái phiếu chính phủ, và Z-spread là spread không đổi cộng vào toàn bộ đường cong giao ngay."
},
{
q: "The minimum rate of return required by investors to purchase an equity security is most likely approximated by the company's:",
opts: ["cost of equity", "return on equity", "weighted average cost of capital"],
ans: 0,
en: "The minimum return equity investors require to hold a share is the cost of equity. Return on equity measures accounting profitability, and WACC blends the required returns of all capital providers.",
vi: "Lợi suất tối thiểu nhà đầu tư cổ phần đòi hỏi để nắm giữ cổ phiếu là chi phí vốn cổ phần. ROE đo khả năng sinh lời kế toán, và WACC pha trộn lợi suất yêu cầu của tất cả bên cấp vốn."
},
{
q: "When defining an asset class for asset allocation, an investor should ensure that assets in the class are relatively:",
opts: ["homogeneous and have low paired correlations with other asset classes", "homogeneous and have high paired correlations with other asset classes", "heterogeneous and have low paired correlations with other asset classes"],
ans: 0,
en: "A useful asset class contains assets that are similar to one another (homogeneous) yet has low correlation with other classes, so that combining classes provides diversification.",
vi: "Một lớp tài sản hữu ích chứa các tài sản tương tự nhau (đồng nhất) nhưng có tương quan thấp với các lớp khác, để việc kết hợp các lớp mang lại đa dạng hóa."
},
{
q: "For an option-free, fixed-rate bond, coupon reinvestment risk most likely dominates market price risk when the investment horizon is:",
opts: ["less than the Macaulay duration of the bond", "equal to the Macaulay duration of the bond", "greater than the Macaulay duration of the bond"],
ans: 2,
en: "When the investment horizon exceeds Macaulay duration, the investor holds long enough that reinvesting coupons dominates. A horizon shorter than duration is dominated by price risk, and a horizon equal to duration balances the two.",
vi: "Khi kỳ đầu tư vượt Macaulay duration, nhà đầu tư nắm giữ đủ lâu để việc tái đầu tư coupon chiếm ưu thế. Kỳ ngắn hơn duration bị chi phối bởi rủi ro giá, và kỳ bằng duration cân bằng hai rủi ro."
},
{
q: "An investor owns a stock trading at USD 22 per share and wants to place an order to sell should the stock ever trade at or below USD 20 per share. The order most likely is a:",
opts: ["limit 20 sell", "stop 20, market sell", "stop 20, limit 20 sell"],
ans: 1,
en: "A stop order at 20 that becomes a market order once triggered will sell as soon as the price falls to 20. A sell limit at 20 would execute immediately at the current 22, and a stop-limit could fail to fill if the price gaps below 20.",
vi: "Lệnh stop tại 20 trở thành lệnh thị trường khi kích hoạt sẽ bán ngay khi giá rơi xuống 20. Lệnh limit bán tại 20 sẽ khớp ngay ở mức 22 hiện tại, và stop-limit có thể không khớp nếu giá nhảy vọt xuống dưới 20."
},
{
q: "Which of the following most likely has the greatest impact on portfolio performance?",
opts: ["The weighting of asset classes", "The selection of securities within sectors", "The trading of securities within asset classes"],
ans: 0,
en: "Asset allocation — the weighting of asset classes — is the dominant driver of portfolio return variability over time, outweighing individual security selection and trading.",
vi: "Phân bổ tài sản — tỷ trọng các lớp tài sản — là yếu tố chi phối chính đối với biến động lợi suất danh mục theo thời gian, lớn hơn việc chọn lựa và giao dịch từng chứng khoán."
},
{
q: "All else equal, the effect of a cash dividend on shareholders' wealth is most likely equivalent to the effect of a:",
opts: ["stock split on shareholders' wealth", "stock dividend on shareholders' wealth", "stock repurchase on shareholders' wealth"],
ans: 2,
en: "A cash dividend and a share repurchase both return cash to shareholders and are economically equivalent in their effect on shareholder wealth, all else equal. Stock splits and stock dividends change share count but not wealth.",
vi: "Cổ tức tiền mặt và mua lại cổ phiếu đều trả tiền về cho cổ đông và tương đương về mặt kinh tế trong tác động đến tài sản cổ đông, các yếu tố khác không đổi. Chia tách cổ phiếu và cổ tức cổ phiếu thay đổi số lượng cổ phiếu chứ không thay đổi tài sản."
},
{
q: "Which statement regarding a commodity index is most accurate?",
opts: ["Commodity indexes commonly use an equal-weighting method", "Commodity indexes in the same markets share similar risk and return profiles", "Commodity index returns differ from the changes in the prices of their underlying commodities"],
ans: 2,
en: "Because commodity indexes are built from futures, their returns include roll yield and collateral return, so they differ from changes in the underlying spot prices. Weighting methods vary widely, and different construction produces different risk-return profiles even in the same markets.",
vi: "Vì chỉ số hàng hóa được xây từ hợp đồng tương lai, lợi suất của chúng bao gồm roll yield và lợi suất tài sản thế chấp, nên khác với thay đổi giá giao ngay của tài sản cơ sở. Phương pháp trọng số rất đa dạng, và cách xây dựng khác nhau tạo hồ sơ rủi ro-lợi suất khác nhau ngay cả trong cùng thị trường."
},
{
q: "An analyst gathers the following about a portfolio and the market. Portfolio: return 11%, standard deviation 18%. Market: return 10%, standard deviation 20%. If the risk-free rate is 4%, the portfolio's M-squared (M2) alpha is closest to:",
opts: ["0.3%", "0.8%", "1.8%"],
ans: 2,
en: "M2 = risk-free rate + (portfolio Sharpe ratio) x market standard deviation = 4 + [(11 - 4)/18] x 20 = 4 + 0.3889 x 20 = 11.78%. The M2 alpha is M2 minus the market return = 11.78 - 10 = 1.78%, or about 1.8%.",
vi: "M2 = lãi suất phi rủi ro + (Sharpe ratio danh mục) x độ lệch chuẩn thị trường = 4 + [(11 - 4)/18] x 20 = 4 + 0.3889 x 20 = 11.78%. M2 alpha là M2 trừ lợi suất thị trường = 11.78 - 10 = 1.78%, tức khoảng 1.8%."
},
{
q: "When developing an IPS, an investor's desire to earn an inflation-adjusted annual rate of return of at least 2% is best classified as a(n):",
opts: ["relative risk objective", "relative return objective", "absolute return objective"],
ans: 2,
en: "A target expressed as a specific return, such as inflation plus 2%, independent of any market benchmark, is an absolute return objective. A relative objective is stated versus a benchmark.",
vi: "Một mục tiêu diễn đạt bằng lợi suất cụ thể, như lạm phát cộng 2%, độc lập với mọi mốc thị trường, là mục tiêu lợi suất tuyệt đối. Mục tiêu tương đối được nêu so với một mốc chuẩn."
},
{
q: "If a forward contract requires no cash outlay at initiation, it is most likely true that at initiation:",
opts: ["value exceeds price", "price exceeds value", "price is equal to value"],
ans: 1,
en: "At initiation a forward has zero value because no cash changes hands, while the forward price is a positive contractual delivery price. Therefore the price exceeds the value at initiation.",
vi: "Tại thời điểm khởi tạo, forward có giá trị bằng 0 vì không có tiền chuyển giao, trong khi giá forward là một mức giá giao hàng theo hợp đồng dương. Do đó giá vượt giá trị tại thời điểm khởi tạo."
},
{
q: "An analyst gathers the following about a company's common stock and the market: dividend per share (D0) USD 3.00; dividend payout ratio 25%; equity beta 1.6; expected risk-free rate 3.5%; expected market return 9.0%; ROE 7.0%. Using the Gordon growth model, the stock's intrinsic value is closest to:",
opts: ["USD 24.96", "USD 42.55", "USD 44.79"],
ans: 2,
en: "Cost of equity via CAPM = 3.5% + 1.6(9.0% - 3.5%) = 12.3%. Growth g = retention x ROE = 0.75 x 7.0% = 5.25%. D1 = 3.00(1.0525) = 3.1575, so value = 3.1575/(0.123 - 0.0525) = 3.1575/0.0705 = USD 44.79.",
vi: "Chi phí vốn cổ phần theo CAPM = 3.5% + 1.6(9.0% - 3.5%) = 12.3%. Tăng trưởng g = tỷ lệ giữ lại x ROE = 0.75 x 7.0% = 5.25%. D1 = 3.00(1.0525) = 3.1575, nên giá trị = 3.1575/(0.123 - 0.0525) = 3.1575/0.0705 = 44.79 USD."
},
{
q: "In general, which of the following institutions most likely has a high need for liquidity and a short investment time horizon?",
opts: ["Banks", "Endowments", "Defined-benefit pension plans"],
ans: 0,
en: "Banks must meet deposit withdrawals on demand, giving them a high liquidity need and a short time horizon. Endowments and defined-benefit pension plans have long horizons and comparatively low liquidity needs.",
vi: "Ngân hàng phải đáp ứng rút tiền gửi bất cứ lúc nào, nên có nhu cầu thanh khoản cao và kỳ đầu tư ngắn. Quỹ hiến tặng và quỹ hưu phúc lợi xác định có kỳ dài và nhu cầu thanh khoản tương đối thấp."
},
{
q: "The money duration of a bond is best defined as:",
opts: ["the bond's Macaulay duration times the bond's full price", "the estimated change in the bond's full price in currency units for a given change in the annual yield to maturity", "one half of the difference in the bond's full prices given a 1 basis point decrease and a 1 basis point increase in yield to maturity"],
ans: 1,
en: "Money duration equals modified duration times the full price and expresses the estimated change in the bond's full price, in currency units, for a given change in yield. The first choice wrongly uses Macaulay duration, and the third describes the price value of a basis point.",
vi: "Money duration bằng modified duration nhân giá đầy đủ (full price) và biểu thị mức thay đổi ước tính của giá đầy đủ, tính bằng đơn vị tiền tệ, cho một thay đổi lợi suất nhất định. Phương án đầu dùng nhầm Macaulay duration, và phương án ba mô tả price value of a basis point."
},
{
q: "A special class of digital assets that peg their value to other financial assets through tokenization are called:",
opts: ["meme coins", "security tokens", "asset-backed tokens"],
ans: 2,
en: "Asset-backed tokens are digital assets whose value is pegged to, and backed by, other underlying assets through tokenization. Meme coins have no such backing, and security tokens represent ownership or investment claims.",
vi: "Asset-backed token là tài sản số có giá trị neo vào và được bảo chứng bởi các tài sản cơ sở khác thông qua token hóa. Meme coin không có bảo chứng như vậy, và security token đại diện quyền sở hữu hoặc quyền đầu tư."
},
{
q: "If the expected return on the market portfolio is 6% and the risk-free rate is 2%, the expected return of a security with a beta of 1.25 is closest to:",
opts: ["5.00%", "7.00%", "9.50%"],
ans: 1,
en: "By the CAPM, expected return = 2% + 1.25(6% - 2%) = 2% + 5% = 7.00%.",
vi: "Theo CAPM, lợi suất kỳ vọng = 2% + 1.25(6% - 2%) = 2% + 5% = 7.00%."
},
{
q: "Compared to alternative investments, traditional investments are most likely characterized by:",
opts: ["greater use of leverage", "a more complex fee structure", "higher levels of transparency"],
ans: 2,
en: "Traditional investments such as listed stocks and bonds offer higher transparency, along with lower leverage and simpler fees, than most alternative investments.",
vi: "Các khoản đầu tư truyền thống như cổ phiếu và trái phiếu niêm yết có tính minh bạch cao hơn, cùng với đòn bẩy thấp hơn và phí đơn giản hơn, so với phần lớn các khoản đầu tư thay thế."
},
{
q: "A 91-day US Treasury bill with a face value of USD 1,000,000 has a price of USD 985,000. Assuming a 360-day year, the discount rate is closest to:",
opts: ["3.8%", "5.9%", "6.0%"],
ans: 1,
en: "The bank discount rate = (discount/face) x (360/days) = (15,000/1,000,000) x (360/91) = 0.015 x 3.956 = 5.9%.",
vi: "Lãi suất chiết khấu ngân hàng = (chiết khấu/mệnh giá) x (360/số ngày) = (15,000/1,000,000) x (360/91) = 0.015 x 3.956 = 5.9%."
},
{
q: "Forward rate agreements can be used by firms to:",
opts: ["lock in a fixed borrowing or lending rate at a future date", "pay the return on an equity index and receive a fixed rate", "hedge against exchange rate fluctuations in foreign-currency investments"],
ans: 0,
en: "A forward rate agreement locks in an interest rate for borrowing or lending starting at a future date. Exchanging an equity index return describes an equity swap, and hedging currency risk uses currency forwards or swaps.",
vi: "Forward rate agreement khóa một lãi suất cho vay hoặc đi vay bắt đầu tại một ngày trong tương lai. Trao đổi lợi suất chỉ số cổ phiếu là equity swap, và phòng ngừa rủi ro tiền tệ dùng forward hoặc swap tiền tệ."
},
{
q: "Buying the stock of a company being acquired while going short the stock of the acquiring company best describes a(n):",
opts: ["activist strategy", "merger arbitrage strategy", "distressed/restructuring strategy"],
ans: 1,
en: "Going long the target and short the acquirer to capture the deal spread is a merger arbitrage strategy. Activist strategies seek to change corporate policy, and distressed strategies invest in troubled companies.",
vi: "Mua cổ phiếu bên bị thâu tóm và bán khống cổ phiếu bên thâu tóm để hưởng chênh lệch thương vụ là chiến lược merger arbitrage. Chiến lược activist tìm cách thay đổi chính sách doanh nghiệp, và distressed đầu tư vào công ty gặp khó khăn."
},
{
q: "Accrued interest:",
opts: ["depends on a bond's yield-to-maturity", "is equal to a bond's full price minus its flat price", "is typically included in the price quoted by bond dealers"],
ans: 1,
en: "Accrued interest is the full (dirty) price minus the flat (clean) price. It depends on the coupon and days since the last coupon rather than the yield, and dealers quote the flat price, which excludes accrued interest.",
vi: "Lãi tích lũy bằng giá đầy đủ (dirty) trừ giá phẳng (clean). Nó phụ thuộc coupon và số ngày kể từ coupon gần nhất chứ không phải lợi suất, và nhà giao dịch yết giá phẳng, vốn không bao gồm lãi tích lũy."
},
{
q: "An investor sells a put option expiring in six months for USD 55.75. The put has an exercise price of USD 190.50. Determine the profit for the investor if the price of the underlying at expiration is USD 195.00.",
opts: ["USD 0.00", "USD 55.75", "USD 60.25"],
ans: 1,
en: "With the underlying at 195.00 above the 190.50 exercise price, the put finishes out of the money and its payoff is zero. The seller keeps the entire premium, so profit = 55.75 - 0 = USD 55.75.",
vi: "Với tài sản cơ sở ở 195.00 cao hơn giá thực hiện 190.50, quyền chọn bán kết thúc ngoài giá và payoff bằng 0. Người bán giữ toàn bộ phí, nên lợi nhuận = 55.75 - 0 = 55.75 USD."
},
{
q: "An analyst gathers the following about an equal-weighted index with three securities. Security 1: 15M shares, begin USD 5, end USD 6. Security 2: 20M shares, begin USD 2, end USD 2. Security 3: 25M shares, begin USD 3, end USD 4. The price return of the index is closest to:",
opts: ["17.8%", "20.0%", "21.1%"],
ans: 0,
en: "An equal-weighted index return is the simple average of the individual price returns: (20% + 0% + 33.33%)/3 = 17.8%. Shares outstanding are irrelevant under equal weighting.",
vi: "Lợi suất chỉ số trọng số bằng nhau là trung bình đơn giản của các lợi suất giá riêng: (20% + 0% + 33.33%)/3 = 17.8%. Số cổ phiếu lưu hành không liên quan khi trọng số bằng nhau."
},
{
q: "Which of the following statements about open-end mutual funds and ETFs is most accurate?",
opts: ["Investors can buy both open-end mutual funds and ETFs from other investors", "Open-end mutual funds can be priced intraday, while ETFs are priced once a day", "ETFs can be settled at a price different from NAV, while open-end mutual funds are settled at NAV"],
ans: 2,
en: "ETFs trade on exchanges at market prices that can differ from NAV, while open-end mutual fund transactions settle at NAV. Open-end funds are priced once a day, not intraday, and their shares are bought from the fund rather than other investors.",
vi: "ETF giao dịch trên sàn theo giá thị trường có thể khác NAV, trong khi giao dịch quỹ mở khớp tại NAV. Quỹ mở được định giá một lần mỗi ngày, không phải trong phiên, và cổ phần được mua từ quỹ chứ không phải từ nhà đầu tư khác."
},
{
q: "Which of the following contracts is an example of a contingent claim? A(n):",
opts: ["currency option", "interest rate swap", "commodity forward"],
ans: 0,
en: "An option is a contingent claim because its payoff occurs only if exercise is favorable. Swaps and forwards are forward commitments that obligate both parties regardless of the outcome.",
vi: "Quyền chọn là một contingent claim vì payoff chỉ xảy ra nếu việc thực hiện có lợi. Swap và forward là cam kết kỳ hạn ràng buộc cả hai bên bất kể kết quả."
},
{
q: "The Markowitz efficient frontier is best described as the part of the minimum-variance frontier of risky assets that plots:",
opts: ["to the right of the risk-free asset", "above the global minimum-variance portfolio", "above and to the right of the optimal risky portfolio"],
ans: 1,
en: "The Markowitz efficient frontier is the upper portion of the minimum-variance frontier, lying above the global minimum-variance portfolio, where each risk level offers the highest available expected return.",
vi: "Markowitz efficient frontier là phần trên của minimum-variance frontier, nằm phía trên global minimum-variance portfolio, nơi mỗi mức rủi ro cho lợi suất kỳ vọng cao nhất có thể."
},
{
q: "Which of the following is most likely an example of a Eurobond?",
opts: ["A Japanese borrower issuing US dollar-denominated bonds in the US market", "A Canadian borrower issuing British pound-denominated bonds in the UK market", "An Australian borrower issuing Canadian dollar-denominated bonds in the UK market"],
ans: 2,
en: "A Eurobond is issued in a currency different from that of the market where it is sold. Canadian dollar bonds sold in the UK market fit this, whereas the other two are denominated in the local currency of the market of issuance (domestic or foreign bonds).",
vi: "Eurobond được phát hành bằng đồng tiền khác với đồng tiền của thị trường nơi bán. Trái phiếu bằng đô la Canada bán ở thị trường Anh phù hợp điều này, trong khi hai phương án kia được định danh bằng nội tệ của thị trường phát hành (trái phiếu nội địa hoặc nước ngoài)."
},
{
q: "Which of the following is the best example of an embedded option granted to bondholders?",
opts: ["A prepayment option", "A put if the issuer's rating changes", "An increasing sinking fund provision"],
ans: 1,
en: "A put triggered by a rating downgrade benefits bondholders by letting them sell the bond back if credit quality deteriorates. A prepayment option and a sinking fund provision benefit the issuer.",
vi: "Một quyền bán (put) kích hoạt khi hạ bậc tín nhiệm có lợi cho trái chủ vì cho phép bán lại trái phiếu nếu chất lượng tín dụng xấu đi. Quyền trả trước (prepayment) và điều khoản quỹ chìm (sinking fund) có lợi cho nhà phát hành."
},
{
q: "In derivatives pricing:",
opts: ["investors are assumed to be risk averse", "a portfolio consisting of the underlying and the derivative must earn the risk-free rate", "expected payoffs of the derivative are discounted at the risk-free rate plus a risk premium"],
ans: 1,
en: "No-arbitrage derivatives pricing builds a hedged portfolio of the underlying and the derivative that must earn the risk-free rate. Valuation is risk-neutral, so investors' risk preferences drop out and expected payoffs are discounted at the risk-free rate alone.",
vi: "Định giá phái sinh theo nguyên tắc không có cơ hội chênh lệch giá xây một danh mục được phòng ngừa gồm tài sản cơ sở và phái sinh, danh mục này phải sinh lợi bằng lãi suất phi rủi ro. Định giá là trung tính rủi ro, nên khẩu vị rủi ro của nhà đầu tư bị loại và payoff kỳ vọng được chiết khấu chỉ bằng lãi suất phi rủi ro."
},
{
q: "A value-weighted equity index is most likely biased by a stock that:",
opts: ["has a high price", "splits frequently", "has a large market capitalization"],
ans: 2,
en: "A value-weighted (market-capitalization-weighted) index is most influenced by stocks with the largest market capitalizations. Stocks with high prices bias price-weighted indexes instead.",
vi: "Chỉ số trọng số theo giá trị (theo vốn hóa) chịu ảnh hưởng lớn nhất từ các cổ phiếu có vốn hóa lớn nhất. Cổ phiếu giá cao lại làm lệch chỉ số trọng số theo giá."
},
{
q: "Which of the following risk metrics reflects the risk of changes in an option's delta?",
opts: ["Rho", "Vega", "Gamma"],
ans: 2,
en: "Gamma measures how much an option's delta changes as the underlying price moves. Rho captures sensitivity to interest rates and vega to volatility.",
vi: "Gamma đo mức thay đổi của delta của quyền chọn khi giá tài sản cơ sở biến động. Rho thể hiện độ nhạy với lãi suất và vega với biến động."
},
{
q: "Before performance fees can be charged on newly generated profits when a hedge fund has experienced losses, the value of the hedge fund must exceed the:",
opts: ["hurdle rate", "carried interest", "high-water mark"],
ans: 2,
en: "A high-water mark requires the fund to recover past losses and surpass its previous peak value before incentive fees are charged again, protecting investors from paying twice on the same gains.",
vi: "High-water mark yêu cầu quỹ phải phục hồi các khoản lỗ trước đó và vượt mức đỉnh cũ trước khi được tính phí thưởng trở lại, bảo vệ nhà đầu tư khỏi trả phí hai lần trên cùng khoản lãi."
},
{
q: "An analyst gathers the following about a hedge fund's first year: beginning assets under management USD 100,000,000; management fee (on end-of-year AUM) 2%; incentive fee (net of the management fee) 20%; annual gross return 15%; soft hurdle rate 5%. The total fees (in USD millions) earned by the hedge fund in Year 1 are:",
opts: ["3.84", "4.30", "4.84"],
ans: 2,
en: "Ending value = 100 x 1.15 = 115, so the 2% management fee = 2.3. With a soft hurdle, once the return clears the hurdle the incentive fee applies to the full gain net of the management fee: 15 - 2.3 = 12.7, and 20% x 12.7 = 2.54. Total fees = 2.3 + 2.54 = 4.84.",
vi: "Giá trị cuối kỳ = 100 x 1.15 = 115, nên phí quản lý 2% = 2.3. Với soft hurdle, khi lợi suất vượt ngưỡng thì phí thưởng áp trên toàn bộ lãi sau phí quản lý: 15 - 2.3 = 12.7, và 20% x 12.7 = 2.54. Tổng phí = 2.3 + 2.54 = 4.84."
},
{
q: "The price of an option-free bond increases by 5% when the yield to maturity decreases by 200 basis points. If the price of this bond decreases by 5%, the yield to maturity most likely increases by:",
opts: ["less than 200 basis points", "200 basis points", "more than 200 basis points"],
ans: 2,
en: "Because of convexity, the price-yield curve is convex: a 5% price rise came from a 200 bps yield fall, but producing an equal 5% price drop requires a larger yield increase, so the yield rises by more than 200 basis points.",
vi: "Do độ lồi (convexity), đường giá-lợi suất là lồi: mức tăng giá 5% đến từ việc lợi suất giảm 200 bps, nhưng để tạo mức giảm giá 5% tương đương cần lợi suất tăng nhiều hơn, nên lợi suất tăng hơn 200 điểm cơ bản."
},
{
q: "A company increased the dividend paid on its common stock by 3% per year over the past three years. If this growth rate is expected to continue indefinitely, the most appropriate model to estimate the intrinsic value of the stock is the:",
opts: ["Gordon growth model", "two-stage dividend discount model", "three-stage dividend discount model"],
ans: 0,
en: "A single, constant growth rate expected to continue forever is exactly the assumption of the Gordon growth (constant growth dividend discount) model. Multi-stage models are used when growth changes over distinct phases.",
vi: "Một tốc độ tăng trưởng duy nhất, không đổi và kéo dài mãi mãi chính là giả định của mô hình Gordon growth (chiết khấu cổ tức tăng trưởng đều). Các mô hình nhiều giai đoạn dùng khi tăng trưởng thay đổi qua các pha khác nhau."
},
{
q: "Credit card receivable asset-backed securities (ABS) are most likely to:",
opts: ["be secured by non-amortizing loans", "have principal repayments reinvested indefinitely", "expose investors to contraction risk during a lockout period"],
ans: 0,
en: "Credit card ABS are backed by non-amortizing, revolving credit balances. During the lockout period principal is reinvested rather than passed through, but only until the amortization period begins, and contraction risk applies to amortizing mortgage products, not these.",
vi: "Credit card ABS được bảo chứng bởi các số dư tín dụng quay vòng, không khấu hao. Trong kỳ khóa (lockout), gốc được tái đầu tư thay vì chuyển giao, nhưng chỉ đến khi bắt đầu kỳ khấu hao, và rủi ro co ngắn (contraction) áp dụng cho sản phẩm thế chấp khấu hao chứ không phải loại này."
},
{
q: "Which alternative investment category most likely provides exposure to capital-intensive, long-lived assets that provide essential public services?",
opts: ["Infrastructure", "Venture capital", "Commercial real estate"],
ans: 0,
en: "Infrastructure investments target capital-intensive, long-lived assets such as roads, utilities, and airports that deliver essential public services and generate stable, long-term cash flows.",
vi: "Đầu tư hạ tầng nhắm đến các tài sản thâm dụng vốn, tuổi thọ dài như đường sá, tiện ích và sân bay, cung cấp dịch vụ công thiết yếu và tạo dòng tiền ổn định, dài hạn."
},
{
q: "In contrast to investors in otherwise-similar mortgage-backed securities, investors in covered bonds most likely:",
opts: ["face higher credit risks", "are exposed to prepayment risks", "have recourse against the issuing financial institution"],
ans: 2,
en: "Covered bond investors have dual recourse: to the segregated cover pool and to the issuing financial institution itself. This lowers their credit risk relative to typical mortgage-backed securities, which usually offer recourse only to the pool.",
vi: "Nhà đầu tư covered bond có quyền truy đòi kép: đối với rổ tài sản bảo đảm tách biệt và đối với chính tổ chức phát hành. Điều này làm giảm rủi ro tín dụng so với chứng khoán bảo đảm bằng thế chấp thông thường, vốn thường chỉ cho truy đòi đối với rổ tài sản."
},
{
q: "A behavioral bias in which an investor assesses the probabilities of outcomes depending on how similar they are to the current state is called:",
opts: ["conservatism", "narrow framing", "representativeness"],
ans: 2,
en: "Representativeness judges probabilities by how closely an outcome resembles a familiar case or the current state, rather than by base rates. Conservatism underweights new information, and narrow framing evaluates decisions in isolation.",
vi: "Representativeness đánh giá xác suất dựa trên mức độ giống của một kết cục với một trường hợp quen thuộc hay trạng thái hiện tại, thay vì theo tỷ lệ cơ sở. Conservatism đánh giá thấp thông tin mới, và narrow framing xét quyết định một cách tách biệt."
},
{
q: "When valuing underlying hedge fund positions, the most conservative approach most likely uses:",
opts: ["the most recent market prices", "the average of the bid and ask prices", "bid prices for longs and ask prices for shorts"],
ans: 2,
en: "The most conservative valuation uses the bid price for long positions (what could be received on sale) and the ask price for short positions (what must be paid to cover), producing the least favorable value.",
vi: "Cách định giá thận trọng nhất dùng giá bid cho vị thế mua (số có thể nhận khi bán) và giá ask cho vị thế bán khống (số phải trả để đóng), cho ra giá trị kém thuận lợi nhất."
},
{
q: "An investor makes two statements. Statement 1: 'Swaps are contingent claims.' Statement 2: 'Swaps are characterized by a series of cash flows.' Which of the statements is correct?",
opts: ["Statement 1 only", "Statement 2 only", "Both Statement 1 and Statement 2"],
ans: 1,
en: "Swaps are forward commitments, not contingent claims, so Statement 1 is wrong. Swaps do involve a series of periodic exchanges of cash flows, so Statement 2 is correct.",
vi: "Swap là cam kết kỳ hạn, không phải contingent claim, nên Statement 1 sai. Swap đúng là bao gồm một chuỗi trao đổi dòng tiền định kỳ, nên Statement 2 đúng."
}
]
});
